...
Store services will be defined in the `github.com/verzth/cosmos-sdk/core/store` package.
...
The event `Service` will be defined in the `github.com/verzth/cosmos-sdk/core/event` package.
...
`github.com/verzth/cosmos-sdk/core/appmodule.AppModule` tag interface. This tag interface requires only two empty methods which
...
Other core extension interfaces will be defined in `github.com/verzth/cosmos-sdk/core` should be supported by valid runtime
implementations.
...
Extension interface for CLI commands will be provided via the `github.com/verzth/cosmos-sdk/client/v2` module and its
...
The `core` module will define a static integer var, `github.com/verzth/cosmos-sdk/core.RuntimeCompatibilityVersion`, which is
