...
:::warning
In the past, validators [have had issues](https://github.com/verzth/cosmos-sdk/issues/13976) when using different versions of Go. It is recommended that the whole validator set uses the version of Go that is preconized by the application.
:::
