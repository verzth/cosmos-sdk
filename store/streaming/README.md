...
[ADR-038](https://github.com/verzth/cosmos-sdk/blob/main/docs/architecture/adr-038-state-listening.md)
and defined in [types/streaming.go](https://github.com/verzth/cosmos-sdk/blob/main/store/types/streaming.go).
