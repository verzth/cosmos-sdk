...
```go
import "github.com/verzth/cosmos-sdk/tools/rosetta/cmd"
```
...
The `RosettaCommand` function builds the `rosetta` root command and is defined in the `rosettaCmd` package (`github.com/verzth/cosmos-sdk/tools/rosetta/cmd`).
...
```bash
go install github.com/verzth/cosmos-sdk/tools/rosetta/cmd/rosetta
```
...
"github.com/verzth/cosmos-sdk/tools/rosetta/lib"
)
...
import crgerrs "github.com/verzth/cosmos-sdk/tools/rosetta/lib/errors"
