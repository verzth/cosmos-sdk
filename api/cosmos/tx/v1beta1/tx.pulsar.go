...
import (
	v1beta12 "github.com/verzth/cosmos-sdk/api/cosmos/base/v1beta1"
	v1beta11 "github.com/verzth/cosmos-sdk/api/cosmos/crypto/multisig/v1beta1"
	v1beta1 "github.com/verzth/cosmos-sdk/api/cosmos/tx/signing/v1beta1"
	fmt "fmt"
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/verzth/cosmos-sdk/issues/9122).
