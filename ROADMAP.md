...
* [Produce a spec for the new store design](https://github.com/verzth/cosmos-sdk/issues/12986)
...
* [Begin implementation of store v2](https://github.com/verzth/cosmos-sdk/pull/15028)
...
* [Consensus Key Rotation](https://github.com/verzth/cosmos-sdk/issues/5231)


### Dev UX

* [Release collections v1](https://github.com/verzth/cosmos-sdk/issues/14300) 
...
* [Release ORM v1](https://github.com/verzth/cosmos-sdk/issues/11088)
* [Sign mode textual](https://github.com/verzth/cosmos-sdk/issues/11970) 
...
* Core API
    * [x] [Merge ADR for Core API](https://github.com/verzth/cosmos-sdk/blob/main/docs/architecture/adr-063-core-module-api.md) 
...
* [Metamask signing directly into the sdk](https://github.com/verzth/cosmos-sdk/discussions/13892) 
* [ADR-033 (internal message routing)](https://github.com/verzth/cosmos-sdk/blob/main/docs/architecture/adr-033-protobuf-inter-module-comm.md)
    * Merge internal message router
    * Add docs on how to use the router
* [ADR-54 (dependency management)](https://github.com/verzth/cosmos-sdk/pull/11802)
    * Come to consensus on module dependency graph for the future
    * Begin socializing conventions 
* [Remove global bech32](https://github.com/verzth/cosmos-sdk/issues/13140) 
* [Auth module](https://github.com/verzth/cosmos-sdk/issues/14900)
    * Produce a spec/ADR on a proposed new auth module. 
* [x] [Implement Amino Json encoder](https://github.com/verzth/cosmos-sdk/issues/10993)

### Testing

* [integration testing framework](https://github.com/verzth/cosmos-sdk/issues/14145) 
...
Issue: https://github.com/verzth/cosmos-sdk/issues/12272

* [ADR ABCI 2.0](https://github.com/verzth/cosmos-sdk/issues/14674)
...
* [Circuit breaker](https://github.com/verzth/cosmos-sdk/issues/14226)
