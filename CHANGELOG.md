...
* (crypto/keyring) [#14151](https://github.com/verzth/cosmos-sdk/pull/14151) Move keys presentation from `crypto/keyring` to `client/keys`
* (modules) [#13850](https://github.com/verzth/cosmos-sdk/pull/13850) and [#14046](https://github.com/verzth/cosmos-sdk/pull/14046) Remove gogoproto stringer annotations. This removes the custom `String()` methods on all types that were using the annotations.
...
* (x/bank) [#12706](https://github.com/verzth/cosmos-sdk/pull/12706) Added the `chain-id` flag to the `AddTxFlagsToCmd` API. There is no longer a need to explicitly register this flag on commands whens `AddTxFlagsToCmd` is already called.
...
* (x/slashing) [#12399](https://github.com/verzth/cosmos-sdk/pull/12399) Migrate `x/slashing` to self-managed parameters and deprecate its usage of `x/params`.
...
* (x/bank) [#12648](https://github.com/verzth/cosmos-sdk/pull/12648) `NewSendAuthorization` takes a new argument of an optional list of addresses allowed to receive bank assets via authz MsgSend grant. You can pass `nil` for the same behavior as before, i.e. any recipient is allowed.
...
* (pruning) [#13609](https://github.com/verzth/cosmos-sdk/pull/13609) Move pruning package to be under store package.
...
* [#13435](https://github.com/verzth/cosmos-sdk/pull/13435) Extend error context when a simulation fails.
...
* [#10326](https://github.com/verzth/cosmos-sdk/pull/10326) `x/authz` add all grants by granter query.
...
* [#11496](https://github.com/verzth/cosmos-sdk/pull/11496) Refactor abstractions for snapshot and pruning; snapshot intervals eventually pruned; unit tests.
...
* [#9650](https://github.com/verzth/cosmos-sdk/pull/9650) Removed deprecated message handler implementation from the SDK modules.
...
* (migrations) [#11556](https://github.com/verzth/cosmos-sdk/pull/11556#issuecomment-1091385011) Remove migration code from 0.42 and below. To use previous migrations, checkout previous versions of the cosmos-sdk.
...
* (x/bank) [#10134](https://github.com/verzth/cosmos-sdk/pull/10134) Add `HasDenomMetadata` function to bank `Keeper` to check if a client coin denom metadata exists in state.
...
* [#10394](https://github.com/verzth/cosmos-sdk/issues/10394) Fixes issue related to grpc-gateway of account balance by
  ibc-denom.
* [#10842](https://github.com/verzth/cosmos-sdk/pull/10842) Fix error when `--generate-only`, `--max-msgs` fags set while executing `WithdrawAllRewards` command.
...
* (types) [#12154](https://github.com/verzth/cosmos-sdk/pull/12154) Add `baseAccountGetter` to avoid invalid account error when create vesting account.
...
* (store) [#12945](https://github.com/verzth/cosmos-sdk/pull/12945) Fix nil end semantics in store/cachekv/iterator when iterating a dirty cache.
* (store) [#13516](https://github.com/verzth/cosmos-sdk/pull/13516) Fix state listener that was observing writes at wrong time.
...
* [#13896](https://github.com/verzth/cosmos-sdk/pull/13896) Queries on pruned height returns error instead of empty values.
* (deps) Bump Tendermint version to [v0.34.23](https://github.com/tendermint/tendermint/releases/tag/v0.34.23).
* (deps) Bump IAVL version to [v0.19.4](https://github.com/cosmos/iavl/releases/tag/v0.19.4).

### Bug Fixes

* [#13673](https://github.com/verzth/cosmos-sdk/pull/13673) Fix `--dry-run` flag not working when using tx command.

### CLI Breaking Changes

* [#13656](https://github.com/verzth/cosmos-sdk/pull/13660) Rename `server.FlagIAVLFastNode` to `server.FlagDisableIAVLFastNode` for clarity.

### API Breaking Changes

* [#13673](https://github.com/verzth/cosmos-sdk/pull/13673) The `GetFromFields` function now takes `Context` as an argument and removes `genOnly`.

## [v0.45.10](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.10) - 2022-10-24

### Features

* (grpc) [#13485](https://github.com/verzth/cosmos-sdk/pull/13485) Implement a new gRPC query, `/cosmos/base/node/v1beta1/config`, which provides operator configuration. Applications that wish to expose operator minimum gas prices via gRPC should have their application implement the `ApplicationQueryService` interface (see `SimApp#RegisterNodeService` as an example).
* [#13557](https://github.com/verzth/cosmos-sdk/pull/#13557) - Add `GenSignedMockTx`. This can be used as workaround for #12437 revertion. `v0.46+` contains as well a `GenSignedMockTx` that behaves the same way.
* (x/auth) [#13612](https://github.com/verzth/cosmos-sdk/pull/13612) Add `Query/ModuleAccountByName` endpoint for accessing the module account info by module name.

### Improvements

* [#13585](https://github.com/verzth/cosmos-sdk/pull/13585) Bump Tendermint to `v0.34.22`.

### Bug Fixes

* [#13588](https://github.com/verzth/cosmos-sdk/pull/13588) Fix regression in distrubtion.WithdrawDelegationRewards when rewards are zero.
* [#13564](https://github.com/verzth/cosmos-sdk/pull/13564) - Fix `make proto-gen`.
* (server) [#13610](https://github.com/verzth/cosmos-sdk/pull/13610) Read the pruning-keep-every field again.

## [v0.45.9](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.9) - 2022-10-14
...
* [#13369](https://github.com/verzth/cosmos-sdk/pull/13369) Improve UX for `keyring.List` by returning all retrieved keys.
* [#13323](https://github.com/verzth/cosmos-sdk/pull/13323) Ensure `withdraw_rewards` rewards are emitted from all actions that result in rewards being withdrawn.
* [#13321](https://github.com/verzth/cosmos-sdk/pull/13321) Add flag to disable fast node migration and usage.
* (store) [#13326](https://github.com/verzth/cosmos-sdk/pull/13326) Implementation of ADR-038 file StreamingService, backport #8664.
* (store) [#13540](https://github.com/verzth/cosmos-sdk/pull/13540) Default fastnode migration to false to prevent suprises. Operators must enable it, unless they have it enabled already.
...
## [v0.45.8](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.8) - 2022-08-25

### Improvements

* [#12981](https://github.com/verzth/cosmos-sdk/pull/12981) Return proper error when parsing telemetry configuration.
* [#12885](https://github.com/verzth/cosmos-sdk/pull/12885) Amortize cost of processing cache KV store.
* [#12970](https://github.com/verzth/cosmos-sdk/pull/12970) Bump Tendermint to `v0.34.21` and IAVL to `v0.19.1`.
* [#12693](https://github.com/verzth/cosmos-sdk/pull/12693) Make sure the order of each node is consistent when emitting proto events.
...
## [v0.45.7](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.7) - 2022-08-04
...
* (events) [#12850](https://github.com/verzth/cosmos-sdk/pull/12850) Add a new `fee_payer` attribute to the `tx` event that is emitted from the `DeductFeeDecorator` AnteHandler decorator.
* (x/params) [#12724](https://github.com/verzth/cosmos-sdk/pull/12724) Add `GetParamSetIfExists` function to params `Subspace` to prevent panics on breaking changes.
* [#12668](https://github.com/verzth/cosmos-sdk/pull/12668) Add `authz_msg_index` event attribute to message events emitted when executing via `MsgExec` through `x/authz`.
* [#12697](https://github.com/verzth/cosmos-sdk/pull/12697) Upgrade IAVL to v0.19.0 with fast index and error propagation. NOTE: first start will take a while to propagate into new model.
...
* [#12784](https://github.com/verzth/cosmos-sdk/pull/12784) Upgrade Tendermint to 0.34.20.
* (x/bank) [#12674](https://github.com/verzth/cosmos-sdk/pull/12674) Add convenience function `CreatePrefixedAccountStoreKey()` to construct key to access account's balance for a given denom.

### Bug Fixes

* (x/mint) [#12384](https://github.com/verzth/cosmos-sdk/pull/12384) Ensure `GoalBonded` must be positive when performing `x/mint` parameter validation.
* (simapp) [#12437](https://github.com/verzth/cosmos-sdk/pull/12437) fix the non-determinstic behavior in simulations caused by `GenTx` and check
empty coins slice before it is used to create `banktype.MsgSend`.
* (x/capability) [12818](https://github.com/verzth/cosmos-sdk/pull/12818) Use fixed length hex for pointer at FwdCapabilityKey.

## [v0.45.6](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.6) - 2022-06-28

### Improvements

* (simapp) [#12314](https://github.com/verzth/cosmos-sdk/pull/12314) Increase `DefaultGenTxGas` from `1000000` to `10000000`
* [#12371](https://github.com/verzth/cosmos-sdk/pull/12371) Update min required Golang version to 1.18.

### Bug Fixes

* [#12317](https://github.com/verzth/cosmos-sdk/pull/12317) Rename `edit-validator` command's `--moniker` flag to `--new-moniker`
* (x/upgrade) [#12264](https://github.com/verzth/cosmos-sdk/pull/12264) Fix `GetLastCompleteUpgrade` to properly return the latest upgrade.
* (x/crisis) [#12208](https://github.com/verzth/cosmos-sdk/pull/12208) Fix progress index of crisis invariant assertion logs.
...
## [v0.45.5](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.5) - 2022-06-09

### Improvements

* (x/feegrant) [#11813](https://github.com/verzth/cosmos-sdk/pull/11813) Fix pagination total count in `AllowancesByGranter` query.
* (errors) [#12002](https://github.com/verzth/cosmos-sdk/pull/12002) Removed 'redacted' error message from defaultErrEncoder.
* (ante) [#12017](https://github.com/verzth/cosmos-sdk/pull/12017) Index ante events for failed tx (backport #12013).
* [#12153](https://github.com/verzth/cosmos-sdk/pull/12153) Add a new `NewSimulationManagerFromAppModules` constructor, to simplify simulation wiring.

### Bug Fixes

* [#11796](https://github.com/verzth/cosmos-sdk/pull/11796) Handle EOF error case in `readLineFromBuf`, which allows successful reading of passphrases from STDIN.
* [#11772](https://github.com/verzth/cosmos-sdk/pull/11772) Limit types.Dec length to avoid overflow.
* [#10947](https://github.com/verzth/cosmos-sdk/pull/10947) Add `AllowancesByGranter` query to the feegrant module
* [#9639](https://github.com/verzth/cosmos-sdk/pull/9639) Check store keys length before accessing them by making sure that `key` is of length `m+1` (for `key[n:m]`)
* [#11983](https://github.com/verzth/cosmos-sdk/pull/11983) (x/feegrant, x/authz) rename grants query commands to `grants-by-grantee`, `grants-by-granter` cmds.
...
* [#11886](https://github.com/verzth/cosmos-sdk/pull/11886) Improve error messages

## [v0.45.4](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.4) - 2022-04-25

### Bug Fixes

* [#11624](https://github.com/verzth/cosmos-sdk/pull/11624) Handle the error returned from `NewNode` in the `server` package.
* [#11724](https://github.com/verzth/cosmos-sdk/pull/11724) Fix data race issues with `api.Server`.
...
* (types) [#12201](https://github.com/verzth/cosmos-sdk/pull/12201) Add `MustAccAddressFromBech32` util function
* [#11693](https://github.com/verzth/cosmos-sdk/pull/11693) Add validation for gentx cmd.
* [#11686](https://github.com/verzth/cosmos-sdk/pull/11686) Update the min required Golang version to `1.17`.
* (x/auth/vesting) [#11652](https://github.com/verzth/cosmos-sdk/pull/11652) Add util functions for `Period(s)`

## [v0.45.3](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.3) - 2022-04-12

### Improvements

* [#11562](https://github.com/verzth/cosmos-sdk/pull/11562) Updated Tendermint to v0.34.19; `unsafe-reset-all` command has been moved to the `tendermint` sub-command.

### Features

* (x/upgrade) [#11551](https://github.com/verzth/cosmos-sdk/pull/11551) Update `ScheduleUpgrade` for chains to schedule an automated upgrade on `BeginBlock` without having to go though governance.

## [v0.45.2](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.2) - 2022-04-05
...
* (x/bank) [#11417](https://github.com/verzth/cosmos-sdk/pull/11417) Introduce a new `SpendableBalances` gRPC query that retrieves an account's total (paginated) spendable balances.
* (x/bank) [#10771](https://github.com/verzth/cosmos-sdk/pull/10771) Add safety check on bank module perms to allow module-specific mint restrictions (e.g. only minting a certain denom).
* (x/bank) [#10771](https://github.com/verzth/cosmos-sdk/pull/10771) Add `bank.BankKeeper.WithMintCoinsRestriction` function to restrict use of bank `MintCoins` usage. This function is not on the bank `Keeper` interface, so it's not API-breaking, but only additive on the keeper implementation.
* [#10944](https://github.com/verzth/cosmos-sdk/pull/10944) `x/authz` add all grants by grantee query
* [#11124](https://github.com/verzth/cosmos-sdk/pull/11124) Add `GetAllVersions` to application store
* (x/auth) [#10880](https://github.com/verzth/cosmos-sdk/pull/10880) Added a new query to the tx query service that returns a block with transactions fully decoded.
* [#11314](https://github.com/verzth/cosmos-sdk/pull/11314) Add state rollback command.
...
* (x/authz) [#11252](https://github.com/verzth/cosmos-sdk/pull/11252) Allow insufficient funds error for authz simulation
* (crypto) [#11298](https://github.com/verzth/cosmos-sdk/pull/11298) Fix cgo secp signature verification and update libscep256k1 library.
* (crypto) [#12122](https://github.com/verzth/cosmos-sdk/pull/12122) Fix keyring migration issue.

### Improvements

* [#9576](https://github.com/verzth/cosmos-sdk/pull/9576) Add debug error message to query result when enabled
* (types) [#11200](https://github.com/verzth/cosmos-sdk/pull/11200) Added `Min()` and `Max()` operations on sdk.Coins.
* [#11267](https://github.com/verzth/cosmos-sdk/pull/11267) Add hooks to allow app modules to add things to state-sync (backport #10961).

## [v0.45.1](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.1) - 2022-02-03
...
* [#10407](https://github.com/verzth/cosmos-sdk/pull/10407) Added validation to `x/upgrade` module's `BeginBlock` to check accidental binary downgrades
* [#10768](https://github.com/verzth/cosmos-sdk/pull/10768) Extra logging in in-place store migrations.

## [v0.45.0](https://github.com/verzth/cosmos-sdk/releases/tag/v0.45.0) - 2022-01-18

### State Machine Breaking

* [#10833](https://github.com/verzth/cosmos-sdk/pull/10833) fix reported tx gas used when block gas limit exceeded.
* (auth) [#10536](https://github.com/verzth/cosmos-sdk/pull/10536]) Enable `SetSequence` for `ModuleAccount`.
* (store) [#10218](https://github.com/verzth/cosmos-sdk/pull/10218) Charge gas even when there are no entries while seeking.
* (store) [#10247](https://github.com/verzth/cosmos-sdk/pull/10247) Charge gas for the key length in gas meter.
* (x/gov) [#10740](https://github.com/verzth/cosmos-sdk/pull/10740) Increase maximum proposal description size from 5k characters to 10k characters.
* [#10814](https://github.com/verzth/cosmos-sdk/pull/10814) revert tx when block gas limit exceeded.

### API Breaking Changes

* [#10561](https://github.com/verzth/cosmos-sdk/pull/10561) The `CommitMultiStore` interface contains a new `SetIAVLCacheSize` method
* [#10922](https://github.com/verzth/cosmos-sdk/pull/10922), [/#10956](https://github.com/verzth/cosmos-sdk/pull/10956) Deprecate key `server.Generate*` functions and move them to `testutil` and support custom mnemonics in in-process testing network. Moved `TestMnemonic` from `testutil` package to `testdata`.
* [#11049](https://github.com/verzth/cosmos-sdk/pull/11049) Add custom tendermint config variables into root command. Allows App developers to set config.toml variables.

### Features

* [#10614](https://github.com/verzth/cosmos-sdk/pull/10614) Support in-place migration ordering

### Improvements

* [#10486](https://github.com/verzth/cosmos-sdk/pull/10486) store/cachekv's `Store.Write` conservatively
...
* (module) [#10711](https://github.com/verzth/cosmos-sdk/pull/10711) Panic at startup if the app developer forgot to add modules in the `SetOrder{BeginBlocker, EndBlocker, InitGenesis, ExportGenesis}` functions. This means that all modules, even those who have empty implementations for those methods, need to be added to `SetOrder*`.
* (types) [#10076](https://github.com/verzth/cosmos-sdk/pull/10076) Significantly speedup and lower allocations for `Coins.String()`.
* (auth) [#10022](https://github.com/verzth/cosmos-sdk/pull/10022) `AuthKeeper` interface in `x/auth` now includes a function `HasAccount`.
* [#10393](https://github.com/verzth/cosmos-sdk/pull/10393) Add `HasSupply` method to bank keeper to ensure that input denom actually exists on chain.

### Bug Fixes

* (std/codec) [/#10595](https://github.com/verzth/cosmos-sdk/pull/10595) Add evidence to std/codec to be able to decode evidence in client interactions.
* (types) [#9627](https://github.com/verzth/cosmos-sdk/pull/9627) Fix nil pointer panic on `NewBigIntFromInt`.
* [#10725](https://github.com/verzth/cosmos-sdk/pull/10725) populate `ctx.ConsensusParams` for begin/end blockers.
* [#9829](https://github.com/verzth/cosmos-sdk/pull/9829) Fixed Coin denom sorting not being checked during `Balance.Validate` check. Refactored the Validation logic to use `Coins.Validate` for `Balance.Coins`
* [#10061](https://github.com/verzth/cosmos-sdk/pull/10061) and [#10515](https://github.com/verzth/cosmos-sdk/pull/10515) Ensure that `LegacyAminoPubKey` struct correctly unmarshals from JSON

## [v0.44.8](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.8) - 2022-04-12

### Improvements

* [#11563](https://github.com/verzth/cosmos-sdk/pull/11563) Updated Tendermint to v0.34.19; `unsafe-reset-all` command has been moved to the `tendermint` sub-command.

## [v0.44.7](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.7) - 2022-04-04
...
## [v0.44.6](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.6) - 2022-02-02
...
* [#10823](https://github.com/verzth/cosmos-sdk/pull/10823) updated ambiguous cli description for creating feegrant.

## [v0.44.5-patch](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.5-patch) - 2021-10-14
...
## [v0.44.5](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.5) - 2021-12-02

### Improvements

* (baseapp) [#10631](https://github.com/verzth/cosmos-sdk/pull/10631) Emit ante events even for the failed txs.
* (store) [#10741](https://github.com/verzth/cosmos-sdk/pull/10741) Significantly speedup iterator creation after delete heavy workloads. Significantly improves IBC migration times.

### Bug Fixes

* [#10648](https://github.com/verzth/cosmos-sdk/pull/10648) Upgrade IAVL to 0.17.3 to solve race condition bug in IAVL.

## [v0.44.4](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.4) - 2021-11-25

### Improvements

* (types) [#10630](https://github.com/verzth/cosmos-sdk/pull/10630) Add an `Events` field to the `TxResponse` type that captures *all* events emitted by a transaction, unlike `Logs` which only contains events emitted during message execution.
* (x/upgrade) [#10532](https://github.com/verzth/cosmos-sdk/pull/10532) Add `keeper.DumpUpgradeInfoWithInfoToDisk` to include `Plan.Info` in the upgrade-info file.
* (store) [#10544](https://github.com/verzth/cosmos-sdk/pull/10544) Use the new IAVL iterator structure which significantly improves iterator performance.

### Bug Fixes

* [#10827](https://github.com/verzth/cosmos-sdk/pull/10827) Create query `Context` with requested block height
* [#10414](https://github.com/verzth/cosmos-sdk/pull/10414) Use `sdk.GetConfig().GetFullBIP44Path()` instead `sdk.FullFundraiserPath` to generate key
* (bank) [#10394](https://github.com/verzth/cosmos-sdk/pull/10394) Fix: query account balance by ibc denom.
* [\10608](https://github.com/verzth/cosmos-sdk/pull/10608) Change the order of module migration by pushing x/auth to the end. Auth module depends on other modules and should be run last. We have updated the documentation to provide more details how to change module migration order. This is technically a breaking change, but only impacts updates between the upgrades with version change, hence migrating from the previous patch release doesn't cause new migration and doesn't break the state.
* [#10674](https://github.com/verzth/cosmos-sdk/pull/10674) Fix issue with `Error.Wrap` and `Error.Wrapf` usage with `errors.Is`.

## [v0.44.3](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.3) - 2021-10-21

### Improvements

* [#10768](https://github.com/verzth/cosmos-sdk/pull/10768) Added extra logging for tracking in-place store migrations
* [#10262](https://github.com/verzth/cosmos-sdk/pull/10262) Remove unnecessary logging in `x/feegrant` simulation.
* [#10327](https://github.com/verzth/cosmos-sdk/pull/10327) Add null guard for possible nil `Amount` in tx fee `Coins`
* [#10339](https://github.com/verzth/cosmos-sdk/pull/10339) Improve performance of `removeZeroCoins` by only allocating memory when necessary
* [#10045](https://github.com/verzth/cosmos-sdk/pull/10045) Revert [#8549](https://github.com/verzth/cosmos-sdk/pull/8549). Do not route grpc queries through Tendermint.
* (deps) [#10375](https://github.com/verzth/cosmos-sdk/pull/10375) Bump Tendermint to [v0.34.14](https://github.com/tendermint/tendermint/releases/tag/v0.34.14).
* [#10024](https://github.com/verzth/cosmos-sdk/pull/10024) `store/cachekv` performance improvement by reduced growth factor for iterator ranging by using binary searches to find dirty items when unsorted key count >= 1024.

### Bug Fixes

* (client) [#10226](https://github.com/verzth/cosmos-sdk/pull/10226) Fix --home flag parsing.
* (rosetta) [#10340](https://github.com/verzth/cosmos-sdk/pull/10340) Use `GenesisChunked(ctx)` instead `Genesis(ctx)` to get genesis block height

## [v0.44.2](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.2) - 2021-10-12

Security Release. No breaking changes related to 0.44.x.

## [v0.44.1](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.1) - 2021-09-29

### Improvements

* (store) [#10040](https://github.com/verzth/cosmos-sdk/pull/10040) Bump IAVL to v0.17.1 which includes performance improvements on a batch load.
* (types) [#10021](https://github.com/verzth/cosmos-sdk/pull/10021) Speedup coins.AmountOf(), by removing many intermittent regex calls.
* [#10077](https://github.com/verzth/cosmos-sdk/pull/10077) Remove telemetry on `GasKV` and `CacheKV` store Get/Set operations, significantly improving their performance.
* (store) [#10026](https://github.com/verzth/cosmos-sdk/pull/10026) Improve CacheKVStore datastructures / algorithms, to no longer take O(N^2) time when interleaving iterators and insertions.

### Bug Fixes

* [#9969](https://github.com/verzth/cosmos-sdk/pull/9969) fix: use keyring in config for add-genesis-account cmd.
* (x/genutil) [#10104](https://github.com/verzth/cosmos-sdk/pull/10104) Ensure the `init` command reads the `--home` flag value correctly.
* (x/feegrant) [#10049](https://github.com/verzth/cosmos-sdk/issues/10049) Fixed the error message when `period` or `period-limit` flag is not set on a feegrant grant transaction.

### Client Breaking Changes

* [#9879](https://github.com/verzth/cosmos-sdk/pull/9879) Modify ABCI Queries to use `abci.QueryRequest` Height field if it is non-zero, otherwise continue using context height.

## [v0.44.0](https://github.com/verzth/cosmos-sdk/releases/tag/v0.44.0) - 2021-09-01

### Features

* [#9860](https://github.com/verzth/cosmos-sdk/pull/9860) Emit transaction fee in ante handler fee decorator. The event type is `tx` and the attribute is `fee`.

### Improvements

* (deps) [#9956](https://github.com/verzth/cosmos-sdk/pull/9956) Bump Tendermint to [v0.34.12](https://github.com/tendermint/tendermint/releases/tag/v0.34.12).
...
* [#9965](https://github.com/verzth/cosmos-sdk/pull/9965) Fixed `simd version` command output to report the right release tag.
* (x/upgrade) [#10189](https://github.com/verzth/cosmos-sdk/issues/10189) Removed potential sources of non-determinism in upgrades.

### Client Breaking Changes

* [#10041](https://github.com/verzth/cosmos-sdk/pull/10041) Remove broadcast & encode legacy REST endpoints. Please see the [REST Endpoints Migration guide](https://docs.cosmos.network/v0.45/migrations/rest.html) to migrate to the new REST endpoints.

## [v0.43.0](https://github.com/verzth/cosmos-sdk/releases/tag/v0.43.0) - 2021-08-10

### Features

* [#6711](https://github.com/verzth/cosmos-sdk/pull/6711) Make integration test suites reusable by apps, tests are exported in each module's `client/testutil` package.
* [#8077](https://github.com/verzth/cosmos-sdk/pull/8077) Added support for grpc-web, enabling browsers to communicate with a chain's gRPC server
* [#8965](https://github.com/verzth/cosmos-sdk/pull/8965) cosmos reflection now provides more information on the application such as: deliverable msgs, sdk.Config info etc (still in alpha stage).
* [#8520](https://github.com/verzth/cosmos-sdk/pull/8520) Add support for permanently locked vesting accounts.
* [#8559](https://github.com/verzth/cosmos-sdk/pull/8559) Added Protobuf compatible secp256r1 ECDSA signatures.
* [#8786](https://github.com/verzth/cosmos-sdk/pull/8786) Enabled secp256r1 in x/auth.
* (rosetta) [#8729](https://github.com/verzth/cosmos-sdk/pull/8729) Data API fully supports balance tracking. Construction API can now construct any message supported by the application.
* [#8754](https://github.com/verzth/cosmos-sdk/pull/8875) Added support for reverse iteration to pagination.
* (types) [#9079](https://github.com/verzth/cosmos-sdk/issues/9079) Add `AddAmount`/`SubAmount` methods to `sdk.Coin`.
* [#9088](https://github.com/verzth/cosmos-sdk/pull/9088) Added implementation to ADR-28 Derived Addresses.
* [#9133](https://github.com/verzth/cosmos-sdk/pull/9133) Added hooks for governance actions.
* (x/staking) [#9214](https://github.com/verzth/cosmos-sdk/pull/9214) Added `new_shares` attribute inside `EventTypeDelegate` event.
* [#9382](https://github.com/verzth/cosmos-sdk/pull/9382) feat: add Dec.Float64() function.
* [#9457](https://github.com/verzth/cosmos-sdk/pull/9457) Add amino support for x/authz and x/feegrant Msgs.
* [#9498](https://github.com/verzth/cosmos-sdk/pull/9498) Added `Codec: codec.Codec` attribute to `client/Context` structure.
* [#9540](https://github.com/verzth/cosmos-sdk/pull/9540) Add output flag for query txs command.
* (errors) [#8845](https://github.com/verzth/cosmos-sdk/pull/8845) Add `Error.Wrap` handy method
* [#8518](https://github.com/verzth/cosmos-sdk/pull/8518) Help users of multisig wallets debug signature issues.
* [#9573](https://github.com/verzth/cosmos-sdk/pull/9573) ADR 040 implementation: New DB interface
* [#9952](https://github.com/verzth/cosmos-sdk/pull/9952) ADR 040: Implement in-memory DB backend
* [#9848](https://github.com/verzth/cosmos-sdk/pull/9848) ADR-040: Implement BadgerDB backend
* [#9851](https://github.com/verzth/cosmos-sdk/pull/9851) ADR-040: Implement RocksDB backend
* [#10308](https://github.com/verzth/cosmos-sdk/pull/10308) ADR-040: Implement DBConnection.Revert
* [#9892](https://github.com/verzth/cosmos-sdk/pull/9892) ADR-040: KV Store with decoupled storage and state commitment

### Client Breaking Changes

* [#8363](https://github.com/verzth/cosmos-sdk/pull/8363) Addresses no longer have a fixed 20-byte length. From the SDK modules' point of view, any 1-255 bytes-long byte array is a valid address.
* (crypto/ed25519) [#8690] Adopt zip1215 ed2559 verification rules.
* [#8849](https://github.com/verzth/cosmos-sdk/pull/8849) Upgrade module no longer supports time based upgrades.
* [#7477](https://github.com/verzth/cosmos-sdk/pull/7477) Changed Bech32 Public Key serialization in the client facing functionality (CLI, MsgServer, QueryServer):
    * updated the keyring display structure (it uses protobuf JSON serialization) - the output is more verbose.
    * Renamed `MarshalAny` and `UnmarshalAny` to `MarshalInterface` and `UnmarshalInterface` respectively. These functions must take an interface as parameter (not a concrete type nor `Any` object). Underneath they use `Any` wrapping for correct protobuf serialization.
    * CLI: removed `--text` flag from `show-node-id` command; the text format for public keys is not used any more - instead we use ProtoJSON.
* (store) [#8790](https://github.com/verzth/cosmos-sdk/pull/8790) Reduce gas costs by 10x for transient store operations.
* [#9139](https://github.com/verzth/cosmos-sdk/pull/9139) Querying events:
    * via `ServiceMsg` TypeURLs (e.g. `message.action='/cosmos.bank.v1beta1.Msg/Send'`) does not work anymore,
    * via legacy `msg.Type()` (e.g. `message.action='send'`) is being deprecated, new `Msg`s won't emit these events.
    * Please use concrete `Msg` TypeURLs instead (e.g. `message.action='/cosmos.bank.v1beta1.MsgSend'`).
* [#9859](https://github.com/verzth/cosmos-sdk/pull/9859) The `default` pruning strategy now keeps the last 362880 blocks instead of 100. 362880 equates to roughly enough blocks to cover the entire unbonding period assuming a 21 day unbonding period and 5s block time.
* [#9785](https://github.com/verzth/cosmos-sdk/issues/9785) Missing coin denomination in logs

### API Breaking Changes

* (keyring) [#8662](https://github.com/verzth/cosmos-sdk/pull/8662) `NewMnemonic` now receives an additional `passphrase` argument to secure the key generated by the bip39 mnemonic.
* (x/bank) [#8473](https://github.com/verzth/cosmos-sdk/pull/8473) Bank keeper does not expose unsafe balance changing methods such as `SetBalance`, `SetSupply` etc.
* (x/staking) [#8473](https://github.com/verzth/cosmos-sdk/pull/8473) On genesis init, if non bonded pool and bonded pool balance, coming from the bank module, does not match what is saved in the staking state, the initialization will panic.
* (x/gov) [#8473](https://github.com/verzth/cosmos-sdk/pull/8473) On genesis init, if the gov module account balance, coming from bank module state, does not match the one in gov module state, the initialization will panic.
* (x/distribution) [#8473](https://github.com/verzth/cosmos-sdk/pull/8473) On genesis init, if the distribution module account balance, coming from bank module state, does not match the one in distribution module state, the initialization will panic.
* (client/keys) [#8500](https://github.com/verzth/cosmos-sdk/pull/8500) `InfoImporter` interface is removed from legacy keybase.
* (x/staking) [#8505](https://github.com/verzth/cosmos-sdk/pull/8505) `sdk.PowerReduction` has been renamed to `sdk.DefaultPowerReduction`, and most staking functions relying on power reduction take a new function argument, instead of relying on that global variable.
* [#8629](https://github.com/verzth/cosmos-sdk/pull/8629) Deprecated `SetFullFundraiserPath` from `Config` in favor of `SetPurpose` and `SetCoinType`.
* (x/upgrade) [#8673](https://github.com/verzth/cosmos-sdk/pull/8673) Remove IBC logic from x/upgrade. Deprecates IBC fields in an Upgrade Plan, an error will be thrown if they are set. IBC upgrade logic moved to 02-client and an IBC UpgradeProposal is added.
* (x/bank) [#8517](https://github.com/verzth/cosmos-sdk/pull/8517) `SupplyI` interface and `Supply` are removed and uses `sdk.Coins` for supply tracking
* (x/upgrade) [#8743](https://github.com/verzth/cosmos-sdk/pull/8743) `UpgradeHandler` includes a new argument `VersionMap` which helps facilitate in-place migrations.
* (x/auth) [#8129](https://github.com/verzth/cosmos-sdk/pull/8828) Updated `SigVerifiableTx.GetPubKeys` method signature to return error.
* (x/upgrade) [\7487](https://github.com/verzth/cosmos-sdk/pull/8897) Upgrade `Keeper` takes new argument `ProtocolVersionSetter` which implements setting a protocol version on baseapp.
* (baseapp) [\7487](https://github.com/verzth/cosmos-sdk/pull/8897) BaseApp's fields appVersion and version were swapped to match Tendermint's fields.
* [#8682](https://github.com/verzth/cosmos-sdk/pull/8682) `ante.NewAnteHandler` updated to receive all positional params as `ante.HandlerOptions` struct. If required fields aren't set, throws error accordingly.
* (x/staking/types) [#7447](https://github.com/verzth/cosmos-sdk/issues/7447) Remove bech32 PubKey support:
    * `ValidatorI` interface update: `GetConsPubKey` renamed to `TmConsPubKey` (this is to clarify the return type: consensus public key must be a tendermint key); `TmConsPubKey`, `GetConsAddr` methods return error.
    * `Validator` updated according to the `ValidatorI` changes described above.
    * `ToTmValidator` function: added `error` to return values.
    * `Validator.ConsensusPubkey` type changed from `string` to `codectypes.Any`.
    * `MsgCreateValidator.Pubkey` type changed from `string` to `codectypes.Any`.
* (client) [#8926](https://github.com/verzth/cosmos-sdk/pull/8926) `client/tx.PrepareFactory` has been converted to a private function, as it's only used internally.
* (auth/tx) [#8926](https://github.com/verzth/cosmos-sdk/pull/8926) The `ProtoTxProvider` interface used as a workaround for transaction simulation has been removed.
* (x/bank) [#8798](https://github.com/verzth/cosmos-sdk/pull/8798) `GetTotalSupply` is removed in favour of `GetPaginatedTotalSupply`
* (keyring) [#8739](https://github.com/verzth/cosmos-sdk/pull/8739) Rename InfoImporter -> LegacyInfoImporter.
* (x/bank/types) [#9061](https://github.com/verzth/cosmos-sdk/pull/9061) `AddressFromBalancesStore` now returns an error for invalid key instead of panic.
* (x/auth) [#9144](https://github.com/verzth/cosmos-sdk/pull/9144) The `NewTxTimeoutHeightDecorator` antehandler has been converted from a struct to a function.
* (codec) [#9226](https://github.com/verzth/cosmos-sdk/pull/9226) Rename codec interfaces and methods, to follow a general Go interfaces:
    * `codec.Marshaler` → `codec.Codec` (this defines objects which serialize other objects)
    * `codec.BinaryMarshaler` → `codec.BinaryCodec`
    * `codec.JSONMarshaler` → `codec.JSONCodec`
    * Removed `BinaryBare` suffix from `BinaryCodec` methods (`MarshalBinaryBare`, `UnmarshalBinaryBare`, ...)
    * Removed `Binary` infix from `BinaryCodec` methods (`MarshalBinaryLengthPrefixed`, `UnmarshalBinaryLengthPrefixed`, ...)
* [#9139](https://github.com/verzth/cosmos-sdk/pull/9139) `ServiceMsg` TypeURLs (e.g. `/cosmos.bank.v1beta1.Msg/Send`) have been removed, as they don't comply to the Probobuf `Any` spec. Please use `Msg` type TypeURLs (e.g. `/cosmos.bank.v1beta1.MsgSend`). This has multiple consequences:
    * The `sdk.ServiceMsg` struct has been removed.
    * `sdk.Msg` now only contains `ValidateBasic` and `GetSigners` methods. The remaining methods `GetSignBytes`, `Route` and `Type` are moved to `legacytx.LegacyMsg`.
    * The `RegisterCustomTypeURL` function and the `cosmos.base.v1beta1.ServiceMsg` interface have been removed from the interface registry.
* (codec) [#9251](https://github.com/verzth/cosmos-sdk/pull/9251) Rename `clientCtx.JSONMarshaler` to `clientCtx.JSONCodec` as per #9226.
* (x/bank) [#9271](https://github.com/verzth/cosmos-sdk/pull/9271) SendEnabledCoin(s) renamed to IsSendEnabledCoin(s) to better reflect its functionality.
* (x/bank) [#9550](https://github.com/verzth/cosmos-sdk/pull/9550) `server.InterceptConfigsPreRunHandler` now takes 2 additional arguments: customAppConfigTemplate and customAppConfig. If you don't need to customize these, simply put `""` and `nil`.
* [#8245](https://github.com/verzth/cosmos-sdk/pull/8245) Removed `simapp.MakeCodecs` and use `simapp.MakeTestEncodingConfig` instead.
* (x/capability) [#9836](https://github.com/verzth/cosmos-sdk/pull/9836) Removed `InitializeAndSeal(ctx sdk.Context)` and replaced with `Seal()`. App must add x/capability module to the begin blockers which will assure that the x/capability keeper is properly initialized. The x/capability begin blocker must be run before any other module which uses x/capability.

### State Machine Breaking

* (x/{bank,distrib,gov,slashing,staking}) [#8363](https://github.com/verzth/cosmos-sdk/issues/8363) Store keys have been modified to allow for variable-length addresses.
* (x/evidence) [#8502](https://github.com/verzth/cosmos-sdk/pull/8502) `HandleEquivocationEvidence` persists the evidence to state.
* (x/gov) [#7733](https://github.com/verzth/cosmos-sdk/pull/7733) ADR 037 Implementation: Governance Split Votes, use `MsgWeightedVote` to send a split vote. Sending a regular `MsgVote` will convert the underlying vote option into a weighted vote with weight 1.
* (x/bank) [#8656](https://github.com/verzth/cosmos-sdk/pull/8656) balance and supply are now correctly tracked via `coin_spent`, `coin_received`, `coinbase` and `burn` events.
* (x/bank) [#8517](https://github.com/verzth/cosmos-sdk/pull/8517) Supply is now stored and tracked as `sdk.Coins`
* (x/bank) [#9051](https://github.com/verzth/cosmos-sdk/pull/9051) Supply value is stored as `sdk.Int` rather than `string`.

### CLI Breaking Changes

* [#8880](https://github.com/verzth/cosmos-sdk/pull/8880) The CLI `simd migrate v0.40 ...` command has been renamed to `simd migrate v0.42`.
* [#8628](https://github.com/verzth/cosmos-sdk/issues/8628) Commands no longer print outputs using `stderr` by default
* [#9134](https://github.com/verzth/cosmos-sdk/pull/9134) Renamed the CLI flag `--memo` to `--note`.
* [#9291](https://github.com/verzth/cosmos-sdk/pull/9291) Migration scripts prior to v0.38 have been removed from the CLI `migrate` command. The oldest supported migration is v0.39->v0.42.
* [#9371](https://github.com/verzth/cosmos-sdk/pull/9371) Non-zero default fees/Server will error if there's an empty value for min-gas-price in app.toml
* [#9827](https://github.com/verzth/cosmos-sdk/pull/9827) Ensure input parity of validator public key input between `tx staking create-validator` and `gentx`.
* [#9621](https://github.com/verzth/cosmos-sdk/pull/9621) Rollback [#9371](https://github.com/verzth/cosmos-sdk/pull/9371) and log warning if there's an empty value for min-gas-price in app.toml

### Improvements

* (store) [#8012](https://github.com/verzth/cosmos-sdk/pull/8012) Implementation of ADR-038 WriteListener and listen.KVStore
* (x/bank) [#8614](https://github.com/verzth/cosmos-sdk/issues/8614) Add `Name` and `Symbol` fields to denom metadata
* (x/auth) [#8522](https://github.com/verzth/cosmos-sdk/pull/8522) Allow to query all stored accounts
* (crypto/types) [#8600](https://github.com/verzth/cosmos-sdk/pull/8600) `CompactBitArray`: optimize the `NumTrueBitsBefore` method and add an `Equal` method.
* (x/upgrade) [#8743](https://github.com/verzth/cosmos-sdk/pull/8743) Add tracking module versions as per ADR-041
* (types) [#8962](https://github.com/verzth/cosmos-sdk/issues/8962) Add `Abs()` method to `sdk.Int`.
* (x/bank) [#8950](https://github.com/verzth/cosmos-sdk/pull/8950) Improve efficiency on supply updates.
* (store) [#8811](https://github.com/verzth/cosmos-sdk/pull/8811) store/cachekv: use typed `types/kv.List` instead of `container/list.List`. The change brings time spent on the time assertion cummulatively to 580ms down from 6.88s.
* (keyring) [#8826](https://github.com/verzth/cosmos-sdk/pull/8826) add trust to macOS Keychain for calling apps by default, avoiding repeating keychain popups that appears when dealing with keyring (key add, list, ...) operations.
* (makefile) [#7933](https://github.com/verzth/cosmos-sdk/issues/7933) Use Docker to generate swagger files.
* (crypto/types) [#9196](https://github.com/verzth/cosmos-sdk/pull/9196) Fix negative index accesses in CompactUnmarshal,GetIndex,SetIndex
* (makefile) [#9192](https://github.com/verzth/cosmos-sdk/pull/9192) Reuse proto containers in proto related jobs.
* [#9205](https://github.com/verzth/cosmos-sdk/pull/9205) Improve readability in `abci` handleQueryP2P
* [#9231](https://github.com/verzth/cosmos-sdk/pull/9231) Remove redundant staking errors.
* [#9314](https://github.com/verzth/cosmos-sdk/pull/9314) Update Rosetta SDK to upstream's latest release.
* (gRPC-Web) [#9493](https://github.com/verzth/cosmos-sdk/pull/9493) Add `EnableUnsafeCORS` flag to grpc-web config.
* (x/params) [#9481](https://github.com/verzth/cosmos-sdk/issues/9481) Speedup simulator for parameter change proposals.
* (x/staking) [#9423](https://github.com/verzth/cosmos-sdk/pull/9423) Staking delegations now returns empty list instead of rpc error when no records found.
* (x/auth) [#9553](https://github.com/verzth/cosmos-sdk/pull/9553) The `--multisig` flag now accepts both a name and address.
* [#8549](https://github.com/verzth/cosmos-sdk/pull/8549) Make gRPC requests go through tendermint Query
* [#8093](https://github.com/verzth/cosmos-sdk/pull/8093) Limit usage of context.background.
* [#8460](https://github.com/verzth/cosmos-sdk/pull/8460) Ensure b.ReportAllocs() in all the benchmarks
* [#8461](https://github.com/verzth/cosmos-sdk/pull/8461) Fix upgrade tx commands not showing up in CLI

### Bug Fixes

* (gRPC) [#8945](https://github.com/verzth/cosmos-sdk/pull/8945) gRPC reflection now works correctly.
* (keyring) [#8635](https://github.com/verzth/cosmos-sdk/issues/8635) Remove hardcoded default passphrase value on `NewMnemonic`
* (x/bank) [#8434](https://github.com/verzth/cosmos-sdk/pull/8434) Fix legacy REST API `GET /bank/total` and `GET /bank/total/{denom}` in swagger
* (x/slashing) [#8427](https://github.com/verzth/cosmos-sdk/pull/8427) Fix query signing infos command
* (x/bank/types) [#9112](https://github.com/verzth/cosmos-sdk/pull/9112) fix AddressFromBalancesStore address length overflow
* (x/bank) [#9229](https://github.com/verzth/cosmos-sdk/pull/9229) Now zero coin balances cannot be added to balances & supply stores. If any denom becomes zero corresponding key gets deleted from store. State migration: [#9664](https://github.com/verzth/cosmos-sdk/pull/9664).
* [#9363](https://github.com/verzth/cosmos-sdk/pull/9363) Check store key uniqueness in app wiring.
* [#9460](https://github.com/verzth/cosmos-sdk/pull/9460) Fix lint error in `MigratePrefixAddress`.
* [#9480](https://github.com/verzth/cosmos-sdk/pull/9480) Fix added keys when using `--dry-run`.
* (types) [#9511](https://github.com/verzth/cosmos-sdk/pull/9511) Change `maxBitLen` of `sdk.Int` and `sdk.Dec` to handle max ERC20 value.
* [#9454](https://github.com/verzth/cosmos-sdk/pull/9454) Fix testnet command with --node-dir-prefix accepts `-` and change `node-dir-prefix token` to `testtoken`.
* (keyring) [#9562](https://github.com/verzth/cosmos-sdk/pull/9563) fix keyring kwallet backend when using with empty wallet.
* (keyring) [#9583](https://github.com/verzth/cosmos-sdk/pull/9583) Fix correct population of legacy `Vote.Option` field for votes with 1 VoteOption of weight 1.
* (x/distinction) [#8918](https://github.com/verzth/cosmos-sdk/pull/8918) Fix module's parameters validation.
* (x/gov/types) [#8586](https://github.com/verzth/cosmos-sdk/pull/8586) Fix bug caused by NewProposal that unnecessarily creates a Proposal object that’s discarded on any error.
* [#8580](https://github.com/verzth/cosmos-sdk/pull/8580) Use more cheaper method from the math/big package that provides a way to trivially check if a value is zero with .BitLen() == 0
* [#8567](https://github.com/verzth/cosmos-sdk/pull/8567) Fix bug by introducing pagination to GetValidatorSetByHeight response
* (x/bank) [#8531](https://github.com/verzth/cosmos-sdk/pull/8531) Fix bug caused by ignoring errors returned by Balance.GetAddress()
* (server) [#8399](https://github.com/verzth/cosmos-sdk/pull/8399) fix gRPC-web flag default value
* [#8282](https://github.com/verzth/cosmos-sdk/pull/8282) fix zero time checks
* (cli) [#9593](https://github.com/verzth/cosmos-sdk/pull/9593) Check if chain-id is blank before verifying signatures in multisign and error.
* [#9720](https://github.com/verzth/cosmos-sdk/pull/9720) Feegrant grant cli granter now accepts key name as well as address in general and accepts only address in --generate-only mode
* [#9793](https://github.com/verzth/cosmos-sdk/pull/9793) Fixed ECDSA/secp256r1 transaction malleability.
* (server) [#9704](https://github.com/verzth/cosmos-sdk/pull/9704) Start GRPCWebServer in goroutine, avoid blocking other services from starting.
* (bank) [#9687](https://github.com/verzth/cosmos-sdk/issues/9687) fixes [#9159](https://github.com/verzth/cosmos-sdk/issues/9159). Added migration to prune balances with zero coins.

### Deprecated

* (grpc) [#8926](https://github.com/verzth/cosmos-sdk/pull/8926) The `tx` field in `SimulateRequest` has been deprecated, prefer to pass `tx_bytes` instead.
* (sdk types) [#9498](https://github.com/verzth/cosmos-sdk/pull/9498) `clientContext.JSONCodec` will be removed in the next version. use `clientContext.Codec` instead.

## [v0.42.10](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.10) - 2021-09-28

### Improvements

* (store) [#10026](https://github.com/verzth/cosmos-sdk/pull/10026) Improve CacheKVStore datastructures / algorithms, to no longer take O(N^2) time when interleaving iterators and insertions.
* (store) [#10040](https://github.com/verzth/cosmos-sdk/pull/10040) Bump IAVL to v0.17.1 which includes performance improvements on a batch load.
* [#10211](https://github.com/verzth/cosmos-sdk/pull/10211) Backport of the mechanism to reject redundant IBC transactions from [ibc-go \#235](https://github.com/cosmos/ibc-go/pull/235).
...
## [v0.42.9](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.9) - 2021-08-04

### Bug Fixes

* [#9835](https://github.com/verzth/cosmos-sdk/pull/9835) Moved capability initialization logic to BeginBlocker to fix nondeterminsim issue mentioned in [#9800](https://github.com/verzth/cosmos-sdk/issues/9800). Applications must now include the capability module in their BeginBlocker order before any module that uses capabilities gets run.
* [#9201](https://github.com/verzth/cosmos-sdk/pull/9201) Fixed `<app> init --recover` flag.

### API Breaking Changes

* [#9835](https://github.com/verzth/cosmos-sdk/pull/9835) The `InitializeAndSeal` API has not changed, however it no longer initializes the in-memory state. `InitMemStore` has been introduced to serve this function, which will be called either in `InitChain` or `BeginBlock` (whichever is first after app start). Nodes may run this version on a network running 0.42.x, however, they must update their app.go files to include the capability module in their begin blockers.

### Client Breaking Changes

* [#9781](https://github.com/verzth/cosmos-sdk/pull/9781) Improve`withdraw-all-rewards` UX when broadcast mode `async` or `async` is used.

## [v0.42.8](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.8) - 2021-07-30

### Features

* [#9750](https://github.com/verzth/cosmos-sdk/pull/9750) Emit events for tx signature and sequence, so clients can now query txs by signature (`tx.signature='<base64_sig>'`) or by address and sequence combo (`tx.acc_seq='<addr>/<seq>'`).

### Improvements

* (cli) [#9717](https://github.com/verzth/cosmos-sdk/pull/9717) Added CLI flag `--output json/text` to `tx` cli commands.

### Bug Fixes

* [#9766](https://github.com/verzth/cosmos-sdk/pull/9766) Fix hardcoded ledger signing algorithm on `keys add` command.

## [v0.42.7](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.7) - 2021-07-09

### Improvements

* (baseapp) [#9578](https://github.com/verzth/cosmos-sdk/pull/9578) Return `Baseapp`'s `trace` value for logging error stack traces.

### Bug Fixes

* (x/ibc) [#9640](https://github.com/verzth/cosmos-sdk/pull/9640) Fix IBC Transfer Ack Success event as it was initially emitting opposite value.
* [#9645](https://github.com/verzth/cosmos-sdk/pull/9645) Use correct Prometheus format for metric labels.
* [#9299](https://github.com/verzth/cosmos-sdk/pull/9299) Fix `[appd] keys parse cosmos1...` freezing.
* (keyring) [#9563](https://github.com/verzth/cosmos-sdk/pull/9563) fix keyring kwallet backend when using with empty wallet.
* (x/capability) [#9392](https://github.com/verzth/cosmos-sdk/pull/9392) initialization fix, which fixes the consensus error when using statesync.

## [v0.42.6](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.6) - 2021-06-18

### Improvements

* [#9428](https://github.com/verzth/cosmos-sdk/pull/9428) Optimize bank InitGenesis. Added `k.initBalances`.
* [#9429](https://github.com/verzth/cosmos-sdk/pull/9429) Add `cosmos_sdk_version` to node_info
* [#9541](https://github.com/verzth/cosmos-sdk/pull/9541) Bump tendermint dependency to v0.34.11.

### Bug Fixes

* [#9385](https://github.com/verzth/cosmos-sdk/pull/9385) Fix IBC `query ibc client header` cli command. Support historical queries for query header/node-state commands.
* [#9401](https://github.com/verzth/cosmos-sdk/pull/9401) Fixes incorrect export of IBC identifier sequences. Previously, the next identifier sequence for clients/connections/channels was not set during genesis export. This resulted in the next identifiers being generated on the new chain to reuse old identifiers (the sequences began again from 0).
* [#9408](https://github.com/verzth/cosmos-sdk/pull/9408) Update simapp to use correct default broadcast mode.
* [#9513](https://github.com/verzth/cosmos-sdk/pull/9513) Fixes testnet CLI command. Testnet now updates the supply in genesis. Previously, when using add-genesis-account and testnet together, inconsistent genesis files would be produced, as only add-genesis-account was updating the supply.
* (x/gov) [#8813](https://github.com/verzth/cosmos-sdk/pull/8813) fix `GET /cosmos/gov/v1beta1/proposals/{proposal_id}/deposits` to include initial deposit

### Features

* [#9383](https://github.com/verzth/cosmos-sdk/pull/9383) New CLI command `query ibc-transfer escrow-address <port> <channel id>` to get the escrow address for a channel; can be used to then query balance of escrowed tokens
* (baseapp, types) [#9390](https://github.com/verzth/cosmos-sdk/pull/9390) Add current block header hash to `Context`
* (store) [#9403](https://github.com/verzth/cosmos-sdk/pull/9403) Add `RefundGas` function to `GasMeter` interface

## [v0.42.5](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.5) - 2021-05-18

### Bug Fixes

* [#9514](https://github.com/verzth/cosmos-sdk/issues/9514) Fix panic when retrieving the `BlockGasMeter` on `(Re)CheckTx` mode.
* [#9235](https://github.com/verzth/cosmos-sdk/pull/9235) CreateMembershipProof/CreateNonMembershipProof now returns an error
  if input key is empty, or input data contains empty key.
* [#9108](https://github.com/verzth/cosmos-sdk/pull/9108) Fixed the bug with querying multisig account, which is not showing threshold and public_keys.
* [#9345](https://github.com/verzth/cosmos-sdk/pull/9345) Fix ARM support.
* [#9040](https://github.com/verzth/cosmos-sdk/pull/9040) Fix ENV variables binding to CLI flags for client config.

### Features

* [#8953](https://github.com/verzth/cosmos-sdk/pull/8953) Add the `config` CLI subcommand back to the SDK, which saves client-side configuration in a `client.toml` file.

## [v0.42.4](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.4) - 2021-04-08

### Client Breaking Changes

* [#9026](https://github.com/verzth/cosmos-sdk/pull/9026) By default, the `tx sign` and `tx sign-batch` CLI commands use SIGN_MODE_DIRECT to sign transactions for local pubkeys. For multisigs and ledger keys, the default LEGACY_AMINO_JSON is used.

### Bug Fixes

* (gRPC) [#9015](https://github.com/verzth/cosmos-sdk/pull/9015) Fix invalid status code when accessing gRPC endpoints.
* [#9026](https://github.com/verzth/cosmos-sdk/pull/9026) Fixed the bug that caused the `gentx` command to fail for Ledger keys.

### Improvements

* [#9081](https://github.com/verzth/cosmos-sdk/pull/9081) Upgrade Tendermint to v0.34.9 that includes a security issue fix for Tendermint light clients.

## [v0.42.3](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.3) - 2021-03-24

This release fixes a security vulnerability identified in x/bank.

## [v0.42.2](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.2) - 2021-03-19

### Improvements

* (grpc) [#8815](https://github.com/verzth/cosmos-sdk/pull/8815) Add orderBy parameter to `TxsByEvents` endpoint.
* (cli) [#8826](https://github.com/verzth/cosmos-sdk/pull/8826) Add trust to macOS Keychain for caller app by default.
* (store) [#8811](https://github.com/verzth/cosmos-sdk/pull/8811) store/cachekv: use typed types/kv.List instead of container/list.List

### Bug Fixes

* (crypto) [#8841](https://github.com/verzth/cosmos-sdk/pull/8841) Fix legacy multisig amino marshaling, allowing migrations to work between v0.39 and v0.40+.
* (cli tx) [\8873](https://github.com/verzth/cosmos-sdk/pull/8873) add missing `--output-document` option to `app tx multisign-batch`.

## [v0.42.1](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.1) - 2021-03-10

This release fixes security vulnerability identified in the simapp.

## [v0.42.0](https://github.com/verzth/cosmos-sdk/releases/tag/v0.42.0) - 2021-03-08

**IMPORTANT**: This release contains an important security fix for all non Cosmos Hub chains running Stargate version of the Cosmos SDK (>0.40). Non-hub chains should not be using any version of the SDK in the v0.40.x or v0.41.x release series. See [#8461](https://github.com/verzth/cosmos-sdk/pull/8461) for more details.

### Improvements

* (x/ibc) [#8624](https://github.com/verzth/cosmos-sdk/pull/8624) Emit full header in IBC UpdateClient message.
* (x/crisis) [#8621](https://github.com/verzth/cosmos-sdk/issues/8621) crisis invariants names now print to loggers.

### Bug fixes

* (x/evidence) [#8461](https://github.com/verzth/cosmos-sdk/pull/8461) Fix bech32 prefix in evidence validator address conversion
* (x/gov) [#8806](https://github.com/verzth/cosmos-sdk/issues/8806) Fix q gov proposals command's mishandling of the --status parameter's values.

## [v0.41.4](https://github.com/verzth/cosmos-sdk/releases/tag/v0.41.3) - 2021-03-02
...
* [#7787](https://github.com/verzth/cosmos-sdk/pull/7787) Add multisign-batch command.

### Bug fixes

* [#8730](https://github.com/verzth/cosmos-sdk/pull/8730) Allow REST endpoint to query txs with multisig addresses.
* [#8680](https://github.com/verzth/cosmos-sdk/issues/8680) Fix missing timestamp in GetTxsEvent response [#8732](https://github.com/verzth/cosmos-sdk/pull/8732).
* [#8681](https://github.com/verzth/cosmos-sdk/issues/8681) Fix missing error message when calling GetTxsEvent [#8732](https://github.com/verzth/cosmos-sdk/pull/8732)
* (server) [#8641](https://github.com/verzth/cosmos-sdk/pull/8641) Fix Tendermint and application configuration reading from file
* (client/keys) [#8639](https://github.com/verzth/cosmos-sdk/pull/8639) Fix keys migrate for mulitisig, offline, and ledger keys. The migrate command now takes a positional old_home_dir argument.

### Improvements

* (store/cachekv), (x/bank/types) [#8719](https://github.com/verzth/cosmos-sdk/pull/8719) algorithmically fix pathologically slow code
* [#8701](https://github.com/verzth/cosmos-sdk/pull/8701) Upgrade tendermint v0.34.8.
* [#8714](https://github.com/verzth/cosmos-sdk/pull/8714) Allow accounts to have a balance of 0 at genesis.

## [v0.41.3](https://github.com/verzth/cosmos-sdk/releases/tag/v0.41.3) - 2021-02-18

### Bug Fixes

* [#8617](https://github.com/verzth/cosmos-sdk/pull/8617) Fix build failures caused by a small API breakage introduced in tendermint v0.34.7.

## [v0.41.2](https://github.com/verzth/cosmos-sdk/releases/tag/v0.41.2) - 2021-02-18

### Improvements

* Bump tendermint dependency to v0.34.7.

## [v0.41.1](https://github.com/verzth/cosmos-sdk/releases/tag/v0.41.1) - 2021-02-17

### Bug Fixes

* (grpc) [#8549](https://github.com/verzth/cosmos-sdk/pull/8549) Make gRPC requests go through ABCI and disallow concurrency.
* (x/staking) [#8546](https://github.com/verzth/cosmos-sdk/pull/8546) Fix caching bug where concurrent calls to GetValidator could cause a node to crash
* (server) [#8481](https://github.com/verzth/cosmos-sdk/pull/8481) Don't create files when running `{appd} tendermint show-*` subcommands.
* (client/keys) [#8436](https://github.com/verzth/cosmos-sdk/pull/8436) Fix keybase->keyring keys migration.
* (crypto/hd) [#8607](https://github.com/verzth/cosmos-sdk/pull/8607) Make DerivePrivateKeyForPath error and not panic on trailing slashes.

### Improvements

* (x/ibc) [#8458](https://github.com/verzth/cosmos-sdk/pull/8458) Add `packet_connection` attribute to ibc events to enable relayer filtering
* [#8396](https://github.com/verzth/cosmos-sdk/pull/8396) Add support for ARM platform
* (x/bank) [#8479](https://github.com/verzth/cosmos-sdk/pull/8479) Aditional client denom metadata validation for `base` and `display` denoms.
* (codec/types) [#8605](https://github.com/verzth/cosmos-sdk/pull/8605) Avoid unnecessary allocations for NewAnyWithCustomTypeURL on error.

## [v0.41.0](https://github.com/verzth/cosmos-sdk/releases/tag/v0.41.0) - 2021-01-26

### State Machine Breaking

* (x/ibc) [#8266](https://github.com/verzth/cosmos-sdk/issues/8266) Add amino JSON support for IBC MsgTransfer in order to support Ledger text signing transfer transactions.
* (x/ibc) [#8404](https://github.com/verzth/cosmos-sdk/pull/8404) Reorder IBC `ChanOpenAck` and `ChanOpenConfirm` handler execution to perform core handler first, followed by application callbacks.

### Bug Fixes

* (simapp) [#8418](https://github.com/verzth/cosmos-sdk/pull/8418) Add balance coin to supply when adding a new genesis account
* (x/bank) [#8417](https://github.com/verzth/cosmos-sdk/pull/8417) Validate balances and coin denom metadata on genesis

## [v0.40.1](https://github.com/verzth/cosmos-sdk/releases/tag/v0.40.1) - 2021-01-19

### Improvements

* (x/bank) [#8302](https://github.com/verzth/cosmos-sdk/issues/8302) Add gRPC and CLI queries for client denomination metadata.
* (tendermint) Bump Tendermint version to [v0.34.3](https://github.com/tendermint/tendermint/releases/tag/v0.34.3).

### Bug Fixes

* [#8085](https://github.com/verzth/cosmos-sdk/pull/8058) fix zero time checks
* [#8280](https://github.com/verzth/cosmos-sdk/pull/8280) fix GET /upgrade/current query
* (x/auth) [#8287](https://github.com/verzth/cosmos-sdk/pull/8287) Fix `tx sign --signature-only` to return correct sequence value in signature.
* (build) [\8300](https://github.com/verzth/cosmos-sdk/pull/8300), [\8301](https://github.com/verzth/cosmos-sdk/pull/8301) Fix reproducible builds
* (types/errors) [#8355](https://github.com/verzth/cosmos-sdk/pull/8355) Fix errorWrap `Is` method.
* (x/ibc) [#8341](https://github.com/verzth/cosmos-sdk/pull/8341) Fix query latest consensus state.
* (proto) [#8350](https://github.com/verzth/cosmos-sdk/pull/8350), [#8361](https://github.com/verzth/cosmos-sdk/pull/8361) Update gogo proto deps with v1.3.2 security fixes
* (x/ibc) [#8359](https://github.com/verzth/cosmos-sdk/pull/8359) Add missing UnpackInterfaces functions to IBC Query Responses. Fixes 'cannot unpack Any' error for IBC types.
* (x/bank) [#8317](https://github.com/verzth/cosmos-sdk/pull/8317) Fix panic when querying for a not found client denomination metadata.

## [v0.40.0](https://github.com/verzth/cosmos-sdk/releases/tag/v0.40.0) - 2021-01-08

v0.40.0, known as the Stargate release of the Cosmos SDK, is one of the largest releases
of the Cosmos SDK since launch. Please read through this changelog and [release notes](https://github.com/verzth/cosmos-sdk/blob/v0.40.0/RELEASE_NOTES.md) to make
sure you are aware of any relevant breaking changes.

### Client Breaking Changes

* **CLI**
    * (client/keys) [#5889](https://github.com/verzth/cosmos-sdk/pull/5889) remove `keys update` command.
    * (x/auth) [#5844](https://github.com/verzth/cosmos-sdk/pull/5844) `tx sign` command now returns an error when signing is attempted with offline/multisig keys.
    * (x/auth) [#6108](https://github.com/verzth/cosmos-sdk/pull/6108) `tx sign` command's `--validate-signatures` flag is migrated into a `tx validate-signatures` standalone command.
    * (x/auth) [#7788](https://github.com/verzth/cosmos-sdk/pull/7788) Remove `tx auth` subcommands, all auth subcommands exist as `tx <subcommand>`
    * (x/genutil) [#6651](https://github.com/verzth/cosmos-sdk/pull/6651) The `gentx` command has been improved. No longer are `--from` and `--name` flags required. Instead, a single argument, `name`, is required which refers to the key pair in the Keyring. In addition, an optional
    `--moniker` flag can be provided to override the moniker found in `config.toml`.
    * (x/upgrade) [#7697](https://github.com/verzth/cosmos-sdk/pull/7697) Rename flag name "--time" to "--upgrade-time", "--info" to "--upgrade-info", to keep it consistent with help message.
* **REST / Queriers**
    * (api) [#6426](https://github.com/verzth/cosmos-sdk/pull/6426) The ability to start an out-of-process API REST server has now been removed. Instead, the API server is now started in-process along with the application and Tendermint. Configuration options have been added to `app.toml` to enable/disable the API server along with additional HTTP server options.
    * (client) [#7246](https://github.com/verzth/cosmos-sdk/pull/7246) The rest server endpoint `/swagger-ui/` is replaced by `/swagger/`, and contains swagger documentation for gRPC Gateway routes in addition to legacy REST routes. Swagger API is exposed only if set in `app.toml`.
    * (x/auth) [#5702](https://github.com/verzth/cosmos-sdk/pull/5702) The `x/auth` querier route has changed from `"acc"` to `"auth"`.
    * (x/bank) [#5572](https://github.com/verzth/cosmos-sdk/pull/5572) The `/bank/balances/{address}` endpoint now returns all account balances or a single balance by denom when the `denom` query parameter is present.
    * (x/evidence) [#5952](https://github.com/verzth/cosmos-sdk/pull/5952) Remove CLI and REST handlers for querying `x/evidence` parameters.
    * (x/gov) [#6295](https://github.com/verzth/cosmos-sdk/pull/6295) Fix typo in querying governance params.
* **General**
    * (baseapp) [#6384](https://github.com/verzth/cosmos-sdk/pull/6384) The `Result.Data` is now a Protocol Buffer encoded binary blob of type `TxData`. The `TxData` contains `Data` which contains a list of Protocol Buffer encoded message data and the corresponding message type.
    * (client) [#5783](https://github.com/verzth/cosmos-sdk/issues/5783) Unify all coins representations on JSON client requests for governance proposals.
    * (crypto) [#7419](https://github.com/verzth/cosmos-sdk/pull/7419) The SDK doesn't use Tendermint's `crypto.PubKey`
    interface anymore, and uses instead it's own `PubKey` interface, defined in `crypto/types`. Replace all instances of
    `crypto.PubKey` by `cryptotypes.Pubkey`.
    * (store/rootmulti) [#6390](https://github.com/verzth/cosmos-sdk/pull/6390) Proofs of empty stores are no longer supported.
    * (store/types) [#5730](https://github.com/verzth/cosmos-sdk/pull/5730) store.types.Cp() is removed in favour of types.CopyBytes().
    * (x/auth) [#6054](https://github.com/verzth/cosmos-sdk/pull/6054) Remove custom JSON marshaling for base accounts as multsigs cannot be bech32 decoded.
    * (x/auth/vesting) [#6859](https://github.com/verzth/cosmos-sdk/pull/6859) Custom JSON marshaling of vesting accounts was removed. Vesting accounts are now marshaled using their default proto or amino JSON representation.
    * (x/bank) [#5785](https://github.com/verzth/cosmos-sdk/issues/5785) In x/bank errors, JSON strings coerced to valid UTF-8 bytes at JSON marshalling time
    are now replaced by human-readable expressions. This change can potentially break compatibility with all those client side tools
    that parse log messages.
    * (x/evidence) [#7538](https://github.com/verzth/cosmos-sdk/pull/7538) The ABCI's `Result.Data` field for
    `MsgSubmitEvidence` responses does not contain the raw evidence's hash, but the protobuf encoded
    `MsgSubmitEvidenceResponse` struct.
    * (x/gov) [#7533](https://github.com/verzth/cosmos-sdk/pull/7533) The ABCI's `Result.Data` field for
    `MsgSubmitProposal` responses does not contain a raw binary encoding of the `proposalID`, but the protobuf encoded
    `MsgSubmitSubmitProposalResponse` struct.
    * (x/gov) [#6859](https://github.com/verzth/cosmos-sdk/pull/6859) `ProposalStatus` and `VoteOption` are now JSON serialized using its protobuf name, so expect names like `PROPOSAL_STATUS_DEPOSIT_PERIOD` as opposed to `DepositPeriod`.
    * (x/staking) [#7499](https://github.com/verzth/cosmos-sdk/pull/7499) `BondStatus` is now a protobuf `enum` instead
    of an `int32`, and JSON serialized using its protobuf name, so expect names like `BOND_STATUS_UNBONDING` as opposed
    to `Unbonding`.
    * (x/staking) [#7556](https://github.com/verzth/cosmos-sdk/pull/7556) The ABCI's `Result.Data` field for
...
* **Baseapp / Client**
    * (AppModule) [#7518](https://github.com/verzth/cosmos-sdk/pull/7518) [#7584](https://github.com/verzth/cosmos-sdk/pull/7584) Rename `AppModule.RegisterQueryServices` to `AppModule.RegisterServices`, as this method now registers multiple services (the gRPC query service and the protobuf Msg service). A `Configurator` struct is used to hold the different services.
    * (baseapp) [#5865](https://github.com/verzth/cosmos-sdk/pull/5865) The `SimulationResponse` returned from tx simulation is now JSON encoded instead of Amino binary.
    * (client) [#6290](https://github.com/verzth/cosmos-sdk/pull/6290) `CLIContext` is renamed to `Context`. `Context` and all related methods have been moved from package context to client.
    * (client) [#6525](https://github.com/verzth/cosmos-sdk/pull/6525) Removed support for `indent` in JSON responses. Clients should consider piping to an external tool such as `jq`.
    * (client) [#8107](https://github.com/verzth/cosmos-sdk/pull/8107) Renamed `PrintOutput` and `PrintOutputLegacy`
    methods of the `context.Client` object to `PrintProto` and `PrintObjectLegacy`.
    * (client/flags) [#6632](https://github.com/verzth/cosmos-sdk/pull/6632) Remove NewCompletionCmd(), the function is now available in tendermint.
    * (client/input) [#5904](https://github.com/verzth/cosmos-sdk/pull/5904) Removal of unnecessary `GetCheckPassword`, `PrintPrefixed` functions.
    * (client/keys) [#5889](https://github.com/verzth/cosmos-sdk/pull/5889) Rename `NewKeyBaseFromDir()` -> `NewLegacyKeyBaseFromDir()`.
    * (client/keys) [#5820](https://github.com/verzth/cosmos-sdk/pull/5820/) Removed method CloseDB from Keybase interface.
    * (client/rpc) [#6290](https://github.com/verzth/cosmos-sdk/pull/6290) `client` package and subdirs reorganization.
    * (client/lcd) [#6290](https://github.com/verzth/cosmos-sdk/pull/6290) `CliCtx` of struct `RestServer` in package client/lcd has been renamed to `ClientCtx`.
    * (codec) [#6330](https://github.com/verzth/cosmos-sdk/pull/6330) `codec.RegisterCrypto` has been moved to the `crypto/codec` package and the global `codec.Cdc` Amino instance has been deprecated and moved to the `codec/legacy_global` package.
    * (codec) [#8080](https://github.com/verzth/cosmos-sdk/pull/8080) Updated the `codec.Marshaler` interface
        * Moved `MarshalAny` and `UnmarshalAny` helper functions to `codec.Marshaler` and renamed to `MarshalInterface` and
      `UnmarshalInterface` respectively. These functions must take interface as a parameter (not a concrete type nor `Any`
      object). Underneath they use `Any` wrapping for correct protobuf serialization.
    * (crypto) [#6780](https://github.com/verzth/cosmos-sdk/issues/6780) Move ledger code to its own package.
    * (crypto/types/multisig) [#6373](https://github.com/verzth/cosmos-sdk/pull/6373) `multisig.Multisignature` has been renamed to `AminoMultisignature`
    * (codec) `*codec.LegacyAmino` is now a wrapper around Amino which provides backwards compatibility with protobuf `Any`. ALL legacy code should use `*codec.LegacyAmino` instead of `*amino.Codec` directly
    * (crypto) [#5880](https://github.com/verzth/cosmos-sdk/pull/5880) Merge `crypto/keys/mintkey` into `crypto`.
    * (crypto/hd) [#5904](https://github.com/verzth/cosmos-sdk/pull/5904) `crypto/keys/hd` moved to `crypto/hd`.
    * (crypto/keyring):
    _ [#5866](https://github.com/verzth/cosmos-sdk/pull/5866) Rename `crypto/keys/` to `crypto/keyring/`.
    _ [#5904](https://github.com/verzth/cosmos-sdk/pull/5904) `Keybase` -> `Keyring` interfaces migration. `LegacyKeybase` interface is added in order
    to guarantee limited backward compatibility with the old Keybase interface for the sole purpose of migrating keys across the new keyring backends. `NewLegacy`
    constructor is provided [#5889](https://github.com/verzth/cosmos-sdk/pull/5889) to allow for smooth migration of keys from the legacy LevelDB based implementation
    to new keyring backends. Plus, the package and the new keyring no longer depends on the sdk.Config singleton. Please consult the [package documentation](https://github.com/verzth/cosmos-sdk/tree/master/crypto/keyring/doc.go) for more
    information on how to implement the new `Keyring` interface. \* [#5858](https://github.com/verzth/cosmos-sdk/pull/5858) Make Keyring store keys by name and address's hexbytes representation.
    * (export) [#5952](https://github.com/verzth/cosmos-sdk/pull/5952) `AppExporter` now returns ABCI consensus parameters to be included in marshaled exported state. These parameters must be returned from the application via the `BaseApp`.
    * (simapp) Deprecating and renaming `MakeEncodingConfig` to `MakeTestEncodingConfig` (both in `simapp` and `simapp/params` packages).
    * (store) [#5803](https://github.com/verzth/cosmos-sdk/pull/5803) The `store.CommitMultiStore` interface now includes the new `snapshots.Snapshotter` interface as well.
    * (types) [#5579](https://github.com/verzth/cosmos-sdk/pull/5579) The `keepRecent` field has been removed from the `PruningOptions` type.
    ...
    * (types) [#5533](https://github.com/verzth/cosmos-sdk/pull/5533) Refactored `AppModuleBasic` and `AppModuleGenesis`
    to now accept a `codec.JSONMarshaler` for modular serialization of genesis state.
    * (types/rest) [#5779](https://github.com/verzth/cosmos-sdk/pull/5779) Drop unused Parse{Int64OrReturnBadRequest,QueryParamBool}() functions.
* **Modules**
    * (modules) [#7243](https://github.com/verzth/cosmos-sdk/pull/7243) Rename `RegisterCodec` to `RegisterLegacyAminoCodec` and `codec.New()` is now renamed to `codec.NewLegacyAmino()`
    * (modules) [#6564](https://github.com/verzth/cosmos-sdk/pull/6564) Constant `DefaultParamspace` is removed from all modules, use ModuleName instead.
    * (modules) [#5989](https://github.com/verzth/cosmos-sdk/pull/5989) `AppModuleBasic.GetTxCmd` now takes a single `CLIContext` parameter.
    * (modules) [#5664](https://github.com/verzth/cosmos-sdk/pull/5664) Remove amino `Codec` from simulation `StoreDecoder`, which now returns a function closure in order to unmarshal the key-value pairs.
    * (modules) [#5555](https://github.com/verzth/cosmos-sdk/pull/5555) Move `x/auth/client/utils/` types and functions to `x/auth/client/`.
    * (modules) [#5572](https://github.com/verzth/cosmos-sdk/pull/5572) Move account balance logic and APIs from `x/auth` to `x/bank`.
    * (modules) [#6326](https://github.com/verzth/cosmos-sdk/pull/6326) `AppModuleBasic.GetQueryCmd` now takes a single `client.Context` parameter.
    * (modules) [#6336](https://github.com/verzth/cosmos-sdk/pull/6336) `AppModuleBasic.RegisterQueryService` method was added to support gRPC queries, and `QuerierRoute` and `NewQuerierHandler` were deprecated.
    * (modules) [#6311](https://github.com/verzth/cosmos-sdk/issues/6311) Remove `alias.go` usage
    * (modules) [#6447](https://github.com/verzth/cosmos-sdk/issues/6447) Rename `blacklistedAddrs` to `blockedAddrs`.
    * (modules) [#6834](https://github.com/verzth/cosmos-sdk/issues/6834) Add `RegisterInterfaces` method to `AppModuleBasic` to support registration of protobuf interface types.
    * (modules) [#6734](https://github.com/verzth/cosmos-sdk/issues/6834) Add `TxEncodingConfig` parameter to `AppModuleBasic.ValidateGenesis` command to support JSON tx decoding in `genutil`.
    * (modules) [#7764](https://github.com/verzth/cosmos-sdk/pull/7764) Added module initialization options:
        * `server/types.AppExporter` requires extra argument: `AppOptions`.
        * `server.AddCommands` requires extra argument: `addStartFlags types.ModuleInitFlags`
        * `x/crisis.NewAppModule` has a new attribute: `skipGenesisInvariants`. [PR](https://github.com/verzth/cosmos-sdk/pull/7764)
    * (types) [#6327](https://github.com/verzth/cosmos-sdk/pull/6327) `sdk.Msg` now inherits `proto.Message`, as a result all `sdk.Msg` types now use pointer semantics.
    * (types) [#7032](https://github.com/verzth/cosmos-sdk/pull/7032) All types ending with `ID` (e.g. `ProposalID`) now end with `Id` (e.g. `ProposalId`), to match default Protobuf generated format. Also see [#7033](https://github.com/verzth/cosmos-sdk/pull/7033) for more details.
    * (x/auth) [#6029](https://github.com/verzth/cosmos-sdk/pull/6029) Module accounts have been moved from `x/supply` to `x/auth`.
    * (x/auth) [#6443](https://github.com/verzth/cosmos-sdk/issues/6443) Move `FeeTx` and `TxWithMemo` interfaces from `x/auth/ante` to `types`.
    * (x/auth) [#7006](https://github.com/verzth/cosmos-sdk/pull/7006) All `AccountRetriever` methods now take `client.Context` as a parameter instead of as a struct member.
    * (x/auth) [#6270](https://github.com/verzth/cosmos-sdk/pull/6270) The passphrase argument has been removed from the signature of the following functions and methods: `BuildAndSign`, ` MakeSignature`, ` SignStdTx`, `TxBuilder.BuildAndSign`, `TxBuilder.Sign`, `TxBuilder.SignStdTx`
    * (x/auth) [#6428](https://github.com/verzth/cosmos-sdk/issues/6428):
        * `NewAnteHandler` and `NewSigVerificationDecorator` both now take a `SignModeHandler` parameter.
        * `SignatureVerificationGasConsumer` now has the signature: `func(meter sdk.GasMeter, sig signing.SignatureV2, params types.Params) error`.
        * The `SigVerifiableTx` interface now has a `GetSignaturesV2() ([]signing.SignatureV2, error)` method and no longer has the `GetSignBytes` method.
    * (x/auth/tx) [#8106](https://github.com/verzth/cosmos-sdk/pull/8106) change related to missing append functionality in
    client transaction signing
        * added `overwriteSig` argument to `x/auth/client.SignTx` and `client/tx.Sign` functions.
        * removed `x/auth/tx.go:wrapper.GetSignatures`. The `wrapper` provides `TxBuilder` functionality, and it's a private
      structure. That function was not used at all and it's not exposed through the `TxBuilder` interface.
    * (x/bank) [#7327](https://github.com/verzth/cosmos-sdk/pull/7327) AddCoins and SubtractCoins no longer return a resultingValue and will only return an error.
    * (x/capability) [#7918](https://github.com/verzth/cosmos-sdk/pull/7918) Add x/capability safety checks:
        * All outward facing APIs will now check that capability is not nil and name is not empty before performing any state-machine changes
        * `SetIndex` has been renamed to `InitializeIndex`
    * (x/evidence) [#7251](https://github.com/verzth/cosmos-sdk/pull/7251) New evidence types and light client evidence handling. The module function names changed.
    * (x/evidence) [#5952](https://github.com/verzth/cosmos-sdk/pull/5952) Remove APIs for getting and setting `x/evidence` parameters. `BaseApp` now uses a `ParamStore` to manage Tendermint consensus parameters which is managed via the `x/params` `Substore` type.
    * (x/gov) [#6147](https://github.com/verzth/cosmos-sdk/pull/6147) The `Content` field on `Proposal` and `MsgSubmitProposal`
    is now `Any` in concordance with [ADR 019](docs/architecture/adr-019-protobuf-state-encoding.md) and `GetContent` should now
    be used to retrieve the actual proposal `Content`. Also the `NewMsgSubmitProposal` constructor now may return an `error`
    * (x/ibc) [#6374](https://github.com/verzth/cosmos-sdk/pull/6374) `VerifyMembership` and `VerifyNonMembership` now take a `specs []string` argument to specify the proof format used for verification. Most SDK chains can simply use `commitmenttypes.GetSDKSpecs()` for this argument.
    * (x/params) [#5619](https://github.com/verzth/cosmos-sdk/pull/5619) The `x/params` keeper now accepts a `codec.Marshaller` instead of
    a reference to an amino codec. Amino is still used for JSON serialization.
    * (x/staking) [#6451](https://github.com/verzth/cosmos-sdk/pull/6451) `DefaultParamspace` and `ParamKeyTable` in staking module are moved from keeper to types to enforce consistency.
    * (x/staking) [#7419](https://github.com/verzth/cosmos-sdk/pull/7419) The `TmConsPubKey` method on ValidatorI has been
    ...
    * (x/staking/types) [#7447](https://github.com/verzth/cosmos-sdk/issues/7447) Remove bech32 PubKey support:
        ...
        * `Validator.ConsensusPubkey` type changed from `string` to `codectypes.Any`.
        * `MsgCreateValidator.Pubkey` type changed from `string` to `codectypes.Any`.
    * (x/supply) [#6010](https://github.com/verzth/cosmos-sdk/pull/6010) All `x/supply` types and APIs have been moved to `x/bank`.
    * [#6409](https://github.com/verzth/cosmos-sdk/pull/6409) Rename all IsEmpty methods to Empty across the codebase and enforce consistency.
    * [#6231](https://github.com/verzth/cosmos-sdk/pull/6231) Simplify `AppModule` interface, `Route` and `NewHandler` methods become only `Route`
    and returns a new `Route` type.
    * (x/slashing) [#6212](https://github.com/verzth/cosmos-sdk/pull/6212) Remove `Get*` prefixes from key construction functions
    * (server) [#6079](https://github.com/verzth/cosmos-sdk/pull/6079) Remove `UpgradeOldPrivValFile` (deprecated in Tendermint Core v0.28).
    * [#5719](https://github.com/verzth/cosmos-sdk/pull/5719) Bump Go requirement to 1.14+

### State Machine Breaking

* **General**

    * (client) [#7268](https://github.com/verzth/cosmos-sdk/pull/7268) / [#7147](https://github.com/verzth/cosmos-sdk/pull/7147) Introduce new protobuf based PubKeys, and migrate PubKey in BaseAccount to use this new protobuf based PubKey format

* **Modules**
    * (modules) [#5572](https://github.com/verzth/cosmos-sdk/pull/5572) Separate balance from accounts per ADR 004.
    ...
    * (x/auth) [#5533](https://github.com/verzth/cosmos-sdk/pull/5533) Migrate the `x/auth` module to use Protocol Buffers for state
    ...
    serialize accounts.
    * (x/bank) [#6518](https://github.com/verzth/cosmos-sdk/pull/6518) Support for global and per-denomination send enabled flags.
        * Existing send_enabled global flag has been moved into a Params structure as `default_send_enabled`.
        * An array of: `{denom: string, enabled: bool}` is added to bank Params to support per-denomination override of global default value.
    * (x/distribution) [#5610](https://github.com/verzth/cosmos-sdk/pull/5610) Migrate the `x/distribution` module to use Protocol Buffers for state
    ...
    * (x/evidence) [#5634](https://github.com/verzth/cosmos-sdk/pull/5634) Migrate the `x/evidence` module to use Protocol Buffers for state
    serialization instead of Amino.
    ...
    interface.
    * (x/evidence) [#5952](https://github.com/verzth/cosmos-sdk/pull/5952) Remove parameters from `x/evidence` genesis and module state. The `x/evidence` module now solely uses Tendermint consensus parameters to determine of evidence is valid or not.
    * (x/gov) [#5737](https://github.com/verzth/cosmos-sdk/pull/5737) Migrate the `x/gov` module to use Protocol
    ...
    * (x/mint) [#5634](https://github.com/verzth/cosmos-sdk/pull/5634) Migrate the `x/mint` module to use Protocol Buffers for state
    serialization instead of Amino. \* The `internal` sub-package has been removed in order to expose the types proto file.
    * (x/slashing) [#5627](https://github.com/verzth/cosmos-sdk/pull/5627) Migrate the `x/slashing` module to use Protocol Buffers for state
    serialization instead of Amino. The exact codec used is `codec.HybridCodec` which utilizes Protobuf for binary encoding and Amino
    for JSON encoding. \* The `Keeper` constructor now takes a `codec.Marshaler` instead of a concrete Amino codec. This exact type
    provided is specified by `ModuleCdc`.
    * (x/staking) [#6844](https://github.com/verzth/cosmos-sdk/pull/6844) Validators are now inserted into the unbonding queue based on their unbonding time and height. The relevant keeper APIs are modified to reflect these changes by now also requiring a height.
    * (x/staking) [#6061](https://github.com/verzth/cosmos-sdk/pull/6061) Allow a validator to immediately unjail when no signing info is present due to
    falling below their minimum self-delegation and never having been bonded. The validator may immediately unjail once they've met their minimum self-delegation.
    * (x/staking) [#5600](https://github.com/verzth/cosmos-sdk/pull/5600) Migrate the `x/staking` module to use Protocol Buffers for state
    serialization instead of Amino. The exact codec used is `codec.HybridCodec` which utilizes Protobuf for binary encoding and Amino
    for JSON encoding.
    ...
    provided is specified by `ModuleCdc`.
    * (x/staking) [#7979](https://github.com/verzth/cosmos-sdk/pull/7979) keeper pubkey storage serialization migration
    from bech32 to protobuf.
    * (x/supply) [#6010](https://github.com/verzth/cosmos-sdk/pull/6010) Removed the `x/supply` module by merging the existing types and APIs into the `x/bank` module.
    * (x/supply) [#5533](https://github.com/verzth/cosmos-sdk/pull/5533) Migrate the `x/supply` module to use Protocol Buffers for state
    serialization instead of Amino.
    _ The `internal` sub-package has been removed in order to expose the types proto file.
    ...
    * (x/upgrade) [#5659](https://github.com/verzth/cosmos-sdk/pull/5659) Migrate the `x/upgrade` module to use Protocol
    Buffers for state serialization instead of Amino.
    _ The `internal` sub-package has been removed in order to expose the types proto file.
...
* **Baseapp / Client / REST**
    * (x/auth) [#6213](https://github.com/verzth/cosmos-sdk/issues/6213) Introduce new protobuf based path for transaction signing, see [ADR020](https://github.com/verzth/cosmos-sdk/blob/master/docs/architecture/adr-020-protobuf-transaction-encoding.md) for more details
    * (x/auth) [#6350](https://github.com/verzth/cosmos-sdk/pull/6350) New sign-batch command to sign StdTx batch files.
    * (baseapp) [#5803](https://github.com/verzth/cosmos-sdk/pull/5803) Added support for taking state snapshots at regular height intervals, via options `snapshot-interval` and `snapshot-keep-recent`.
    * (baseapp) [#7519](https://github.com/verzth/cosmos-sdk/pull/7519) Add `ServiceMsgRouter` to BaseApp to handle routing of protobuf service `Msg`s. The two new types defined in ADR 031, `sdk.ServiceMsg` and `sdk.MsgRequest` are introduced with this router.
    * (client) [#5921](https://github.com/verzth/cosmos-sdk/issues/5921) Introduce new gRPC and gRPC Gateway based APIs for querying app & module data. See [ADR021](https://github.com/verzth/cosmos-sdk/blob/master/docs/architecture/adr-021-protobuf-query-encoding.md) for more details
    * (cli) [#7485](https://github.com/verzth/cosmos-sdk/pull/7485) Introduce a new optional `--keyring-dir` flag that allows clients to specify a Keyring directory if it does not reside in the directory specified by `--home`.
    * (cli) [#7221](https://github.com/verzth/cosmos-sdk/pull/7221) Add the option of emitting amino encoded json from the CLI
    * (codec) [#7519](https://github.com/verzth/cosmos-sdk/pull/7519) `InterfaceRegistry` now inherits `jsonpb.AnyResolver`, and has a `RegisterCustomTypeURL` method to support ADR 031 packing of `Any`s. `AnyResolver` is now a required parameter to `RejectUnknownFields`.
    * (coin) [#6755](https://github.com/verzth/cosmos-sdk/pull/6755) Add custom regex validation for `Coin` denom by overwriting `CoinDenomRegex` when using `/types/coin.go`.
    * (config) [#7265](https://github.com/verzth/cosmos-sdk/pull/7265) Support Tendermint block pruning through a new `min-retain-blocks` configuration that can be set in either `app.toml` or via the CLI. This parameter is used in conjunction with other criteria to determine the height at which Tendermint should prune blocks.
    * (events) [#7121](https://github.com/verzth/cosmos-sdk/pull/7121) The application now derives what events are indexed by Tendermint via the `index-events` configuration in `app.toml`, which is a list of events taking the form `{eventType}.{attributeKey}`.
    * (tx) [#6089](https://github.com/verzth/cosmos-sdk/pull/6089) Transactions can now have a `TimeoutHeight` set which allows the transaction to be rejected if it's committed at a height greater than the timeout.
    * (rest) [#6167](https://github.com/verzth/cosmos-sdk/pull/6167) Support `max-body-bytes` CLI flag for the REST service.
    * (genesis) [#7089](https://github.com/verzth/cosmos-sdk/pull/7089) The `export` command now adds a `initial_height` field in the exported JSON. Baseapp's `CommitMultiStore` now also has a `SetInitialVersion` setter, so it can set the initial store version inside `InitChain` and start a new chain from a given height.
* **General**
    * (crypto/multisig) [#6241](https://github.com/verzth/cosmos-sdk/pull/6241) Add Multisig type directly to the repo. Previously this was in tendermint.
    * (codec/types) [#8106](https://github.com/verzth/cosmos-sdk/pull/8106) Adding `NewAnyWithCustomTypeURL` to correctly
    marshal Messages in TxBuilder.
    * (tests) [#6489](https://github.com/verzth/cosmos-sdk/pull/6489) Introduce package `testutil`, new in-process testing network framework for use in integration and unit tests.
    * (tx) Add new auth/tx gRPC & gRPC-Gateway endpoints for basic querying & broadcasting support
        * [#7842](https://github.com/verzth/cosmos-sdk/pull/7842) Add TxsByEvent gRPC endpoint
        * [#7852](https://github.com/verzth/cosmos-sdk/pull/7852) Add tx broadcast gRPC endpoint
    * (tx) [#7688](https://github.com/verzth/cosmos-sdk/pull/7688) Add a new Tx gRPC service with methods `Simulate` and `GetTx` (by hash).
    * (store) [#5803](https://github.com/verzth/cosmos-sdk/pull/5803) Added `rootmulti.Store` methods for taking and restoring snapshots, based on `iavl.Store` export/import.
    * (store) [#6324](https://github.com/verzth/cosmos-sdk/pull/6324) IAVL store query proofs now return CommitmentOp which wraps an ics23 CommitmentProof
    * (store) [#6390](https://github.com/verzth/cosmos-sdk/pull/6390) `RootMulti` store query proofs now return `CommitmentOp` which wraps `CommitmentProofs`
        * `store.Query` now only returns chained `ics23.CommitmentProof` wrapped in `merkle.Proof`
        * `ProofRuntime` only decodes and verifies `ics23.CommitmentProof`
* **Modules**
    * (modules) [#5921](https://github.com/verzth/cosmos-sdk/issues/5921) Introduction of Query gRPC service definitions along with REST annotations for gRPC Gateway for each module
    * (modules) [#7540](https://github.com/verzth/cosmos-sdk/issues/7540) Protobuf service definitions can now be used for
    packing `Msg`s in transactions as defined in [ADR 031](./docs/architecture/adr-031-msg-service.md). All modules now
    define a `Msg` protobuf service.
    * (x/auth/vesting) [#7209](https://github.com/verzth/cosmos-sdk/pull/7209) Create new `MsgCreateVestingAccount` message type along with CLI handler that allows for the creation of delayed and continuous vesting types.
    * (x/capability) [#5828](https://github.com/verzth/cosmos-sdk/pull/5828) Capability module integration as outlined in [ADR 3 - Dynamic Capability Store](https://github.com/cosmos/tree/master/docs/architecture/adr-003-dynamic-capability-store.md).
    * (x/crisis) `x/crisis` has a new function: `AddModuleInitFlags`, which will register optional crisis module flags for the start command.
    * (x/ibc) [#5277](https://github.com/verzth/cosmos-sdk/pull/5277) `x/ibc` changes from IBC alpha. For more details check the [`x/ibc/core/spec`](https://github.com/verzth/cosmos-sdk/tree/master/x/ibc/core/spec) directory, or the ICS specs below:
    ...
    * (x/ibc) [#6374](https://github.com/verzth/cosmos-sdk/pull/6374) ICS-23 Verify functions will now accept and verify ics23 CommitmentProofs exclusively
    * (x/params) [#6005](https://github.com/verzth/cosmos-sdk/pull/6005) Add new CLI command for querying raw x/params parameters by subspace and key.

### Bug Fixes

* **Baseapp / Client / REST**
    * (client) [#5964](https://github.com/verzth/cosmos-sdk/issues/5964) `--trust-node` is now false by default - for real. Users must ensure it is set to true if they don't want to enable the verifier.
    * (client) [#6402](https://github.com/verzth/cosmos-sdk/issues/6402) Fix `keys add` `--algo` flag which only worked for Tendermint's `secp256k1` default key signing algorithm.
    * (client) [#7699](https://github.com/verzth/cosmos-sdk/pull/7699) Fix panic in context when setting invalid nodeURI. `WithNodeURI` does not set the `Client` in the context.
    * (export) [#6510](https://github.com/verzth/cosmos-sdk/pull/6510/) Field TimeIotaMs now is included in genesis file while exporting.
    * (rest) [#5906](https://github.com/verzth/cosmos-sdk/pull/5906) Fix an issue that make some REST calls panic when sending invalid or incomplete requests.
    * (crypto) [#7966](https://github.com/verzth/cosmos-sdk/issues/7966) `Bip44Params` `String()` function now correctly
    returns the absolute HD path by adding the `m/` prefix.
    * (crypto/keyring) [#5844](https://github.com/verzth/cosmos-sdk/pull/5844) `Keyring.Sign()` methods no longer decode amino signatures when method receivers
    are offline/multisig keys.
    * (store) [#7415](https://github.com/verzth/cosmos-sdk/pull/7415) Allow new stores to be registered during on-chain upgrades.
* **Modules**
  _ (modules) [#5569](https://github.com/verzth/cosmos-sdk/issues/5569) `InitGenesis`, for the relevant modules, now ensures module accounts exist.
  _ (x/auth) [#5892](https://github.com/verzth/cosmos-sdk/pull/5892) Add `RegisterKeyTypeCodec` to register new
  types (eg. keys) to the `auth` module internal amino codec.
  _ (x/bank) [#6536](https://github.com/verzth/cosmos-sdk/pull/6536) Fix bug in `WriteGeneratedTxResponse` function used by multiple
  REST endpoints. Now it writes a Tx in StdTx format.
  _ (x/genutil) [#5938](https://github.com/verzth/cosmos-sdk/pull/5938) Fix `InitializeNodeValidatorFiles` error handling.
  _ (x/gentx) [#8183](https://github.com/verzth/cosmos-sdk/pull/8183) change gentx cmd amount to arg from flag
  _ (x/gov) [#7641](https://github.com/verzth/cosmos-sdk/pull/7641) Fix tally calculation precision error.
  _ (x/staking) [#6529](https://github.com/verzth/cosmos-sdk/pull/6529) Export validator addresses (previously was empty).
  _ (x/staking) [#5949](https://github.com/verzth/cosmos-sdk/pull/5949) Skip staking `HistoricalInfoKey` in simulations as headers are not exported. \* (x/staking) [#6061](https://github.com/verzth/cosmos-sdk/pull/6061) Allow a validator to immediately unjail when no signing info is present due to
  falling below their minimum self-delegation and never having been bonded. The validator may immediately unjail once they've met their minimum self-delegation.
* **General**
    * (types) [#7038](https://github.com/verzth/cosmos-sdk/issues/7038) Fix infinite looping of `ApproxRoot` by including a hard-coded maximum iterations limit of 100.
    * (types) [#7084](https://github.com/verzth/cosmos-sdk/pull/7084) Fix panic when calling `BigInt()` on an uninitialized `Int`.
    * (simulation) [#7129](https://github.com/verzth/cosmos-sdk/issues/7129) Fix support for custom `Account` and key types on auth's simulation.

### Improvements

* **Baseapp / Client / REST**
    * (baseapp) [#6186](https://github.com/verzth/cosmos-sdk/issues/6186) Support emitting events during `AnteHandler` execution.
    * (baseapp) [#6053](https://github.com/verzth/cosmos-sdk/pull/6053) Customizable panic recovery handling added for `app.runTx()` method (as proposed in the [ADR 22](https://github.com/verzth/cosmos-sdk/blob/master/docs/architecture/adr-022-custom-panic-handling.md)). Adds ability for developers to register custom panic handlers extending standard ones.
    * (client) [#5810](https://github.com/verzth/cosmos-sdk/pull/5810) Added a new `--offline` flag that allows commands to be executed without an
    internet connection. Previously, `--generate-only` served this purpose in addition to only allowing txs to be generated. Now, `--generate-only` solely
    allows txs to be generated without being broadcasted and disallows Keybase use and `--offline` allows the use of Keybase but does not allow any
    functionality that requires an online connection.
    * (cli) [#7764](https://github.com/verzth/cosmos-sdk/pull/7764) Update x/banking and x/crisis InitChain to improve node startup time
    * (client) [#5856](https://github.com/verzth/cosmos-sdk/pull/5856) Added the possibility to set `--offline` flag with config command.
    * (client) [#5895](https://github.com/verzth/cosmos-sdk/issues/5895) show config options in the config command's help screen.
    * (client/keys) [#8043](https://github.com/verzth/cosmos-sdk/pull/8043) Add support for export of unarmored private key
    * (client/tx) [#7801](https://github.com/verzth/cosmos-sdk/pull/7801) Update sign-batch multisig to work online
    * (x/genutil) [#8099](https://github.com/verzth/cosmos-sdk/pull/8099) `init` now supports a `--recover` flag to recover
    the private validator key from a given mnemonic
* **Modules**
    * (x/auth) [#5702](https://github.com/verzth/cosmos-sdk/pull/5702) Add parameter querying support for `x/auth`.
    * (x/auth/ante) [#6040](https://github.com/verzth/cosmos-sdk/pull/6040) `AccountKeeper` interface used for `NewAnteHandler` and handler's decorators to add support of using custom `AccountKeeper` implementations.
    * (x/evidence) [#5952](https://github.com/verzth/cosmos-sdk/pull/5952) Tendermint Consensus parameters can now be changed via parameter change proposals through `x/gov`.
    * (x/evidence) [#5961](https://github.com/verzth/cosmos-sdk/issues/5961) Add `StoreDecoder` simulation for evidence module.
    * (x/ibc) [#5948](https://github.com/verzth/cosmos-sdk/issues/5948) Add `InitGenesis` and `ExportGenesis` functions for `ibc` module.
    * (x/ibc-transfer) [#6871](https://github.com/verzth/cosmos-sdk/pull/6871) Implement [ADR 001 - Coin Source Tracing](./docs/architecture/adr-001-coin-source-tracing.md).
    * (x/staking) [#6059](https://github.com/verzth/cosmos-sdk/pull/6059) Updated `HistoricalEntries` parameter default to 100.
    * (x/staking) [#5584](https://github.com/verzth/cosmos-sdk/pull/5584) Add util function `ToTmValidator` that converts a `staking.Validator` type to `*tmtypes.Validator`.
    * (x/staking) [#6163](https://github.com/verzth/cosmos-sdk/pull/6163) CLI and REST call to unbonding delegations and delegations now accept
    pagination.
    * (x/staking) [#8178](https://github.com/verzth/cosmos-sdk/pull/8178) Update default historical header number for stargate
* **General**
    * (crypto) [#7987](https://github.com/verzth/cosmos-sdk/pull/7987) Fix the inconsistency of CryptoCdc, only use
    `codec/legacy.Cdc`.
    * (logging) [#8072](https://github.com/verzth/cosmos-sdk/pull/8072) Refactor logging:
    ...
    * (rest) [#7649](https://github.com/verzth/cosmos-sdk/pull/7649) Return an unsigned tx in legacy GET /tx endpoint when signature conversion fails
    * (simulation) [#6002](https://github.com/verzth/cosmos-sdk/pull/6002) Add randomized consensus params into simulation.
    * (store) [#6481](https://github.com/verzth/cosmos-sdk/pull/6481) Move `SimpleProofsFromMap` from Tendermint into the SDK.
    * (store) [#6719](https://github.com/verzth/cosmos-sdk/6754) Add validity checks to stores for nil and empty keys.
    * (SDK) Updated dependencies
        * Updated iavl dependency to v0.15.3
        * Update tendermint to v0.34.1
    * (types) [#7027](https://github.com/verzth/cosmos-sdk/pull/7027) `Coin(s)` and `DecCoin(s)` updates:
        * Bump denomination max length to 128
        * Allow uppercase letters and numbers in denominations to support [ADR 001](./docs/architecture/adr-001-coin-source-tracing.md)
        * Added `Validate` function that returns a descriptive error
    * (types) [#5581](https://github.com/verzth/cosmos-sdk/pull/5581) Add convenience functions {,Must}Bech32ifyAddressBytes.
    * (types/module) [#5724](https://github.com/verzth/cosmos-sdk/issues/5724) The `types/module` package does no longer depend on `x/simulation`.
    * (types) [#5585](https://github.com/verzth/cosmos-sdk/pull/5585) IBC additions:
        * `Coin` denomination max lenght has been increased to 32.
        * Added `CapabilityKey` alias for `StoreKey` to match IBC spec.
    * (types/rest) [#5900](https://github.com/verzth/cosmos-sdk/pull/5900) Add Check\*Error function family to spare developers from replicating tons of boilerplate code.
    * (types) [#6128](https://github.com/verzth/cosmos-sdk/pull/6137) Add `String()` method to `GasMeter`.
    * (types) [#6195](https://github.com/verzth/cosmos-sdk/pull/6195) Add codespace to broadcast(sync/async) response.
    * (types) [#6897](https://github.com/verzth/cosmos-sdk/issues/6897) Add KV type from tendermint to `types` directory.
    * (version) [#7848](https://github.com/verzth/cosmos-sdk/pull/7848) [#7941](https://github.com/verzth/cosmos-sdk/pull/7941)
    `version --long` output now shows the list of build dependencies and replaced build dependencies.

## Previous Releases

[CHANGELOG of previous versions](https://github.com/verzth/cosmos-sdk/blob/c17c3caab86a1426a1eef4541e8203f5f54a1a54/CHANGELOG.md#v0391---2020-08-11) (pre Stargate).
